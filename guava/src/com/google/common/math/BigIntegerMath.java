...
public final class BigIntegerMath {
    ...
    public static int log10(BigInteger x, RoundingMode mode) {
        ...
        if (approxCmp > 0) {
            /*
             * The code is written so that even completely incorrect approximations will still yield
             * the correct answer eventually, but in practice this branch should almost never be
             * entered, and even then the loop should not run more than once.
             */
            do {
                approxLog10--;
    ...
    private static BigInteger sqrtFloor(BigInteger x) {
         ...
         * then we can get a double approximation of the square root. Then, we iteratively improve
         * this guess with an application of Newton's method, which sets guess := (guess + (x /
         ...
         * because guess' is the arithmetic mean of guess and x / guess, sqrt(x) is the geometric
         * mean, and the arithmetic mean is always higher than the geometric mean.
         *
         * b) this iteration converges to floor(sqrt(x)). In fact, the number of correct digits
         * doubles with each iteration, so this algorithm takes O(log(digits)) iterations.
         *
         ...
         * definitely >= floor(sqrt(x)), and then continue the iteration until we reach a fixed
         * point.
         */
        BigInteger sqrt0;
    ...
    /**
     * Returns {@code n!}, that is, the product of the first {@code n} positive integers, or
     * {@code 1} if {@code n == 0}.
     *
     * <p>
     ...
     * multiplies. It also removes all the 2s from the intermediate products (shifting them back in
     * at the end).
     *
