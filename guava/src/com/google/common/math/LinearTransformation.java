...
public abstract class LinearTransformation {
    ...
    /**
     * Start building an instance which maps {@code x = x1} to {@code y = y1}. Both arguments must
     * be finite. Call either {@link LinearTransformationBuilder#and} or
     ...
     * {@link LinearTransformation#mapping}. You almost certainly don't want to keep instances
     * around, but instead use method chaining. This represents a single point mapping, i.e. a
     * mapping between one {@code x} and {@code y} value pair.
     */
    public static final class LinearTransformationBuilder {
        ...
        /**
         * Finish building an instance which also maps {@code x = x2} to {@code y = y2}. These
         * values must not both be identical to the values given in the first mapping. If only the
         * {@code x} values are identical, the transformation is vertical. If only the {@code y}
        ...
        /**
         * Finish building an instance with the given slope, i.e. the rate of change of {@code y}
         * with respect to {@code x}. The slope must not be {@code NaN}. It may be infinite, in
         * which case the transformation is vertical. (If it is zero, the transformation is
         * horizontal.)
         */
     ...
     * {@code y}. (The inverse of this will be a vertical transformation.)
     */
     ...
     * the same instance. Calling this method on the result of calling this method on an instance
     * will always return that original instance.
     */
