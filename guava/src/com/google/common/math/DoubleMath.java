...
public final class DoubleMath {
    ...
    /**
     * Returns the base 2 logarithm of a double value, rounded with the specified rounding mode to
     * an {@code int}.
     *
     * <p>
     ...
     * if {@code n == 0}, or {@code n!}, or {@link Double#POSITIVE_INFINITY} if
    ...
    public static double mean(int... values) {
        checkArgument(values.length > 0, "Cannot take mean of 0 values");
        // The upper bound on the the length of an array and the bounds on the int values mean that,
        // in
