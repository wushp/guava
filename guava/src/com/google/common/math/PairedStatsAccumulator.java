...
public final class PairedStatsAccumulator {
    ...
    // These fields must satisfy the requirements of PairedStats' constructor as well as those of
    // the
    ...
    public void add(double x, double y) {
        ...
        // Programming
        // vol. 2, Knuth, 4.2.2, (16) to the two-variable case. We have two value series x_i and
        // y_i.
        // We define the arithmetic means X_n = 1/n \sum_{i=1}^n x_i, and Y_n = 1/n \sum_{i=1}^n
        // y_i.
    ...
    public void addAll(PairedStats values) {
        ...
        if (yStats.count() == 0) {
            ...
            // This is a generalized version of the calculation in add(double, double) above. Note
            // that
            // non-finite inputs will have sumOfProductsOfDeltas = NaN, so non-finite values will
            // result
            // in NaN naturally.
