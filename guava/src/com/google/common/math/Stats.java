 ...
 *
 * <p>
 * <b>Java 8 users:</b> If you are not using any of the variance statistics, you may wish to use
...
public final class Stats implements Serializable {
     ...
     * result is {@link Double#NaN}. If it contains {@link Double#POSITIVE_INFINITY} and finite
     * values only or {@link Double#POSITIVE_INFINITY} only, the result is
     * {@link Double#POSITIVE_INFINITY}. If it contains {@link Double#NEGATIVE_INFINITY} and finite
     * values only or {@link Double#NEGATIVE_INFINITY} only, the result is
     * {@link Double#NEGATIVE_INFINITY}.
     *
     * <p>
     * If you only want to calculate the mean, use {#meanOf} instead of creating a {@link Stats}
     * instance.
     *
     ...
     * unbiased estimator of the population variance of the population. The count must be greater
     * than one.
     *
     * <p>
     ...
     * corrected sample standard deviation</a> of the values. If this dataset is a sample drawn from
     * a population, this is an estimator of the population standard deviation of the population
     * which is less biased than {@link #populationStandardDeviation()} (the unbiased estimator
     * depends on the distribution). The count must be greater than one.
     *
     * <p>
     * This is not guaranteed to return zero when the dataset consists of the same value multiple
     * times, due to numerical errors. However, it is guaranteed never to return a negative result.
     ...
     * versions.
     *
     * @param buffer A {@link ByteBuffer} with at least BYTES {@link ByteBuffer#remaining}, ordered
     *        as {@link ByteOrder#LITTLE_ENDIAN}, to which a BYTES-long byte representation of this
     ...
     *
     * @param buffer A {@link ByteBuffer} with at least BYTES {@link ByteBuffer#remaining}, ordered
     *        as {@link ByteOrder#LITTLE_ENDIAN}, from which a BYTES-long byte representation of
     *        this instance is read. In the process increases the position of {@link ByteBuffer} by
     *        BYTES.
     */
