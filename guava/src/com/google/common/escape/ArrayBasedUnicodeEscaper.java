 ...
 *
 * <p>
 * A good example of usage of this class is for HTML escaping where the replacement array contains
 * information about the named HTML entities such as {@code &amp;} and {@code &quot;} while
 * {@link #escapeUnsafe} is overridden to handle general escaping of the form {@code &#NNNNN;}.
 *
 * <p>
 * The size of the data structure used by {@link ArrayBasedUnicodeEscaper} is proportional to the
