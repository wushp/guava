...
public final class Escapers {
    ...
    /**
     * Returns an {@link Escaper} that does no escaping, passing all character data through
     * unchanged.
     */
    ...
    /**
     * Returns a builder for creating simple, fast escapers. A builder instance can be reused and
     * each escaper that is created will be a snapshot of the current builder state. Builders are
     * not thread safe.
     *
     * <p>
    ...
    public static final class Builder {
        ...
        /**
         * Sets the replacement string for any characters outside the 'safe' range that have no
         * explicit replacement. If {@code unsafeReplacement} is {@code null} then no replacement
         * will occur, if it is {@code ""} then the unsafe characters are removed from the output.
         *
         ...
         * replaced by the given string whenever it occurs in the input, irrespective of whether it
         * lies inside or outside the 'safe' range.
         *
     ...
     * {@code null} if no replacement should be made. This method is intended for use in tests
     * through the {@code EscaperAsserts} class; production users of {@link CharEscaper} should
     * limit themselves to its public interface.
     *
     ...
     * Returns a string that would replace the given character in the specified escaper, or
     * {@code null} if no replacement should be made. This method is intended for use in tests
     * through the {@code EscaperAsserts} class; production users of {@link UnicodeEscaper} should
     * limit themselves to its public interface.
     *
