 ...
 *
 * <p>
 * The size of the data structure used by {@link ArrayBasedCharEscaper} is proportional to the
...
public abstract class ArrayBasedCharEscaper extends CharEscaper {
    ...
    /**
     * Creates a new ArrayBasedCharEscaper instance with the given replacement map and specified
     * safe range. If {@code safeMax < safeMin} then no characters are considered safe.
     *
     * <p>
    ...
    /**
     * Creates a new ArrayBasedCharEscaper instance with the given replacement map and specified
     * safe range. If {@code safeMax < safeMin} then no characters are considered safe. This
