...
public final class UnsignedLongs {
     ...
     * lesser. For example, {@code [] < [1L] < [1L, 2L] < [2L] < [1L << 63]}.
     *
     * <p>
    ...
    public static long divide(long dividend, long divisor) {
        ...
        /*
         * Otherwise, approximate the quotient, check, and correct if necessary. Our approximation
         * is guaranteed to be either exact or one less than the correct value. This follows from
    ...
    public static long remainder(long dividend, long divisor) {
         ...
         * Otherwise, approximate the quotient, check, and correct if necessary. Our approximation
         * is guaranteed to be either exact or one less than the correct value. This follows from
         * the fact that floor(floor(x)/i) == floor(x/i) for any real x and integer i != 0. The
