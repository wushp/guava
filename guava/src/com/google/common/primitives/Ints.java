...
public final class Ints {
     ...
     *         {@link Integer#MAX_VALUE} if it is too large, or {@link Integer#MIN_VALUE} if it is
     *         too small
     */
     ...
     *
     * <p>
     * If you need to convert and concatenate several values (possibly even of different types), use
     * a shared {@link java.nio.ByteBuffer} instance, or use
    ...
    /**
     * Returns the {@code int} value whose big-endian representation is stored in the first 4 bytes
     * of {@code bytes}; equivalent to {@code ByteBuffer.wrap(bytes).getInt()}. For example, the
     * input byte array {@code {0x12, 0x13, 0x14, 0x15, 0x33}} would yield the {@code int} value
     * {@code 0x12131415}.
     *
     * <p>
     ...
     *
     * <p>
     * <b>Warning:</b> please see {@link Integer#decode} to understand exactly how strings are
     * parsed. For example, the string {@code "0123"} is treated as <i>octal</i> and converted to
     * the value {@code 83}.
     *
     * @since 16.0
     */
    ...
    /**
     * Returns a string containing the supplied {@code int} values separated by {@code separator}.
     ...
     * it compares, using {@link #compare(int, int)}), the first pair of values that follow any
     * common prefix, or when one array is a prefix of the other, treats the shorter array as the
     * lesser. For example, {@code [] < [1] < [1, 2] < [2]}.
     *
     * <p>
    ...
    /**
     * Returns an array containing each value of {@code collection}, converted to a {@code int}
     * value in the manner of {@link Number#intValue}.
     *
     * <p>
     ...
     *
     * <p>
     * Unlike {@link Integer#parseInt(String)}, this method returns {@code null} instead of throwing
     * an exception if parsing fails. Additionally, this method only accepts ASCII digits, and
     * returns {@code null} if non-ASCII digits are present in the string.
     *
     * <p>
     * Note that strings prefixed with ASCII {@code '+'} are rejected, even under JDK 7, despite the
     * change to {@link Integer#parseInt(String)} for that version.
     *
     * @param string the string representation of an integer value
     * @return the integer value represented by {@code string}, or {@code null} if {@code string}
     *         has a length of zero or cannot be parsed as an integer value
     * @since 11.0
     */
    @Beta
    @Nullable
     ...
     * <p>
     * Note that strings prefixed with ASCII {@code '+'} are rejected, even under JDK 7, despite the
     * change to {@link Integer#parseInt(String, int)} for that version.
     *
     * @param string the string representation of an integer value
     * @param radix the radix to use when parsing
     * @return the integer value represented by {@code string} using {@code radix}, or {@code null}
     *         if {@code string} has a length of zero or cannot be parsed as an integer value
