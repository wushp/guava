...
public final class Doubles {
    ...
    /**
     * Compares the two specified {@code double} values. The sign of the value returned is the same
     * as that of <code>((Double) a).{@linkplain Double#compareTo compareTo}(b)</code>. As with that
     * method, {@code NaN} is treated as greater than all other values, and {@code 0.0 > -0.0}.
     *
     * <p>
     * <b>Note:</b> this method simply delegates to the JDK method {@link Double#compare}. It is
     ...
     * not necessarily implemented as, {@code !(Double.isInfinite(value) || Double.isNaN(value))}.
     *
     * <p>
     ...
     * Note that this always returns {@code false} when {@code target} is {@code NaN}.
     *
     ...
     * specified by {@link Double#toString(double)}, and separated by {@code separator}. For
     * example, {@code join("-", 1.0, 2.0, 3.0)} returns the string {@code "1.0-2.0-3.0"}.
     *
     * <p>
     ...
     * it compares, using {@link #compare(double, double)}), the first pair of values that follow
     * any common prefix, or when one array is a prefix of the other, treats the shorter array as
     * the lesser. For example, {@code [] < [1.0] < [1.0, 2.0] < [2.0]}.
     *
     * <p>
