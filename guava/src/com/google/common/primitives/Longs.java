...
public final class Longs {
     ...
     *
     * <p>
     * This method always return the value specified by {@link Long#hashCode()} in java, which might
     * be different from {@code ((Long) value).hashCode()} in GWT because {@link Long#hashCode()} in
     * GWT does not obey the JRE contract.
     *
     * <p>
     ...
     * {@code concat(new long[] {a, b}, new long[] {}, new long[] {c}} returns the array {@code {a,
     * b, c}}.
     *
    ...
    /**
     * Returns a big-endian representation of {@code value} in an 8-element byte array; equivalent
     * to {@code ByteBuffer.allocate(8).putLong(value).array()}. For example, the input value
     ...
     *
     * <p>
     * Unlike {@link Long#parseLong(String)}, this method returns {@code null} instead of throwing
     ...
     * change to {@link Long#parseLong(String)} for that version.
     *
     ...
     *
     * <p>
     * Unlike {@link Long#parseLong(String, int)}, this method returns {@code null} instead of
     * throwing an exception if parsing fails. Additionally, this method only accepts ASCII digits,
     * and returns {@code null} if non-ASCII digits are present in the string.
     *
     * <p>
     * Note that strings prefixed with ASCII {@code '+'} are rejected, even under JDK 7, despite the
     * change to {@link Long#parseLong(String, int)} for that version.
     *
     ...
     *
     * <p>
     * <b>Warning:</b> please see {@link Long#decode} to understand exactly how strings are parsed.
     ...
     * it compares, using {@link #compare(long, long)}), the first pair of values that follow any
     * common prefix, or when one array is a prefix of the other, treats the shorter array as the
     * lesser. For example, {@code [] < [1L] < [1L, 2L] < [2L]}.
     *
     * <p>
    ...
    /**
     * Returns an array containing each value of {@code collection}, converted to a {@code long}
     * value in the manner of {@link Number#longValue}.
     *
     * <p>
     ...
     *
     * <p>
     * The returned list maintains the values, but not the identities, of {@code Long} objects
