 ...
 *
 * <p>
 * All the operations in this class treat {@code char} values strictly numerically; they are neither
 * Unicode-aware nor locale-dependent.
 *
 * <p>
...
public final class Chars {
     ...
     *         {@link Character#MAX_VALUE} if it is too large, or {@link Character#MIN_VALUE} if it
     *         is too small
     */
     ...
     * {@code concat(new char[] {a, b}, new char[] {}, new char[] {c}} returns the array {@code {a,
     * b, c}}.
     *
     ...
     * it compares, using {@link #compare(char, char)}), the first pair of values that follow any
     ...
     *
     * <p>
     * The returned list maintains the values, but not the identities, of {@code Character} objects
