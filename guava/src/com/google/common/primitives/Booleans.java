...
public final class Booleans {
     ...
     *
     * <p>
     * <b>Note:</b> consider representing the array as a {@link java.util.BitSet} instead, replacing
     ...
     *
     * <p>
     * <b>Note:</b> consider representing the array as a {@link java.util.BitSet} instead, and using
     * {@link java.util.BitSet#nextSetBit(int)} or {@link java.util.BitSet#nextClearBit(int)}.
     *
     * @param array an array of {@code boolean} values, possibly empty
     * @param target a primitive {@code boolean} value
     ...
     * {@code separator}. For example, {@code join("-", false, true, false)} returns the string
     ...
     * it compares, using {@link #compare(boolean, boolean)}), the first pair of values that follow
     * any common prefix, or when one array is a prefix of the other, treats the shorter array as
     * the lesser. For example, {@code [] < [false] < [false, true] < [true]}.
     *
     * <p>
     ...
     *
     * <p>
     * <b>Note:</b> consider representing the collection as a {@link java.util.BitSet} instead.
     *
     ...
     *
     * <p>
     * The returned list maintains the values, but not the identities, of {@code Boolean} objects
