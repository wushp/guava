...
public final class Shorts {
     ...
     *         {@link Short#MAX_VALUE} if it is too large, or {@link Short#MIN_VALUE} if it is too
     *         small
     */
    ...
    /**
     * Compares the two specified {@code short} values. The sign of the value returned is the same
     * as that of {@code ((Short) a).compareTo(b)}.
     *
     * <p>
    ...
    /**
     * Returns the {@code short} value whose big-endian representation is stored in the first 2
     * bytes of {@code bytes}; equivalent to {@code ByteBuffer.wrap(bytes).getShort()}. For example,
     * the input byte array {@code {0x54, 0x32}} would yield the {@code short} value {@code 0x5432}.
     *
     * <p>
     ...
     *
     * <p>
     * <b>Warning:</b> please see {@link Short#decode} to understand exactly how strings are parsed.
     ...
     * it compares, using {@link #compare(short, short)}), the first pair of values that follow any
