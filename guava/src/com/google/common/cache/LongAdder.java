 ...
 *
 * <p>
 * This class is usually preferable to {@link AtomicLong} when multiple threads update a common sum
 * that is used for purposes such as collecting statistics, not for fine-grained synchronization
 ...
 * compareTo} because instances are expected to be mutated, and so are not useful as collection
 * keys.
 *
 * <p>
...
final class LongAdder extends Striped64 implements Serializable, LongAddable {
     ...
     * the absence of concurrent updates returns an accurate result, but concurrent updates that
