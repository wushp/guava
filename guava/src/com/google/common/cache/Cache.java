...
public interface Cache<K, V> {
     ...
     * <li>{@linkplain LoadingCache#refresh refreshing of entries}, including
     * {@linkplain CacheBuilder#refreshAfterWrite automated refreshing}
     * <li>{@linkplain LoadingCache#getAll bulk loading requests}, including
     * {@linkplain CacheLoader#loadAll bulk loading implementations}
     * </ul>
     *
     * <p>
     * <b>Warning:</b> For any given key, every {@code loader} used with it should compute the same
     ...
     *
     * <p>
     * <b>Warning:</b> as with {@link CacheLoader#load}, {@code loader} <b>must not</b> return
     ...
     * if the cache is not recording statistics. All statistics begin at zero and never decrease
     * over the lifetime of the cache.
     *
     * <p>
     * <b>Warning:</b> this cache may not be recording statistical data. For example, a cache
     * created using {@link CacheBuilder} only does so if the {@link CacheBuilder#recordStats}
     * method was called. If statistics are not being recorded, a {@code CacheStats} instance with
     * zero for all values is returned.
     *
     */
    CacheStats stats();
