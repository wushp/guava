 ...
 *
 * <p>
 * The set of supported keys will grow as {@code CacheBuilder} evolves, but existing keys will never
 * be removed.
 *
 * <p>
 * Durations are represented by an integer, followed by one of "d", "h", "m", or "s", representing
 * days, hours, minutes, or seconds respectively. (There is currently no syntax to request
 * expiration in milliseconds, microseconds, or nanoseconds.)
 *
 * <p>
 ...
 *
 * <p>
 * {@code CacheBuilderSpec} does not support configuring {@code CacheBuilder} methods with non-value
