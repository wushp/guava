...
public abstract class CacheLoader<K, V> {
     ...
     * @return the future new value associated with {@code key}; <b>must not be null, must not
     *         return null</b>
    ...
    /**
     * Returns a cache loader based on an <i>existing</i> function instance. Note that there's no
     * need to create a <i>new</i> function just to pass it in here; just subclass
     * {@code CacheLoader} and implement {@link #load load} instead.
     *
    ...
    /**
     * Returns a cache loader based on an <i>existing</i> supplier instance. Note that there's no
     * need to create a <i>new</i> supplier just to pass it in here; just subclass
     * {@code CacheLoader} and implement {@link #load load} instead.
     *
