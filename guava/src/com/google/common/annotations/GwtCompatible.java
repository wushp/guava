 ...
 *
 * <p>
 * The return value of {@code Lists.newArrayList(E[])} has GWT serializable type. It is also useful
 * in specifying contracts of interface methods. In the following example,
 *
 * <pre>
 * {@literal @}GwtCompatible
 ...
 *
 * <p>
 * The {@code newArrayList(E[])} method of all implementations of {@code ListFactory} is expected to
 * return a value with a GWT serializable type.
 *
 * <p>
