...
public @interface GwtIncompatible {
    /**
     * Describes why the annotated element is incompatible with GWT. Since this is generally due to
     * a dependence on a type/method which GWT doesn't support, it is sufficient to simply reference
