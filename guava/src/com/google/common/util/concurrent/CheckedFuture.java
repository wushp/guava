 ...
 *
 * <p>
 * Implementations of this interface must adapt the exceptions thrown by {@code Future#get()}:
 ...
 *
 * <p>
 * This interface also extends the ListenableFuture interface to allow listeners to be added. This
 * allows the future to be used as a normal {@link Future} or as an asynchronous callback mechanism
 * as needed. This allows multiple callbacks to be registered for a particular task, and the future
 * will guarantee execution of all listeners when the task completes.
 *
 * <p>
...
public interface CheckedFuture<V, X extends Exception> extends ListenableFuture<V> {
     ...
     * {@link InterruptedException}, {@link CancellationException} and {@link ExecutionException}
    ...
    /**
     * Exception checking version of {@link Future#get(long, TimeUnit)} that will translate
     * {@link InterruptedException}, {@link CancellationException} and {@link ExecutionException}
     * into application-specific exceptions. On timeout this method throws a normal
