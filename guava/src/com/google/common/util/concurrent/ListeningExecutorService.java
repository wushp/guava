...
public interface ListeningExecutorService extends ExecutorService {
     ...
     *
     * <p>
     * All elements in the returned list must be {@link ListenableFuture} instances. The easiest way
     * to obtain a {@code List<ListenableFuture<T>>} from this method is an unchecked (but safe)
     * cast:
     * 
     * <pre>
     ...
     *         sequential order as produced by the iterator for the given task list, each of which
     *         has completed.
     * @throws RejectedExecutionException {@inheritDoc}
     ...
     *
     * @return a list of {@code ListenableFuture} instances representing the tasks, in the same
     *         sequential order as produced by the iterator for the given task list. If the
