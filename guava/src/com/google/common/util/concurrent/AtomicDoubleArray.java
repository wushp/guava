...
/*
 * Source:
 * http://gee.cs.oswego.edu/cgi-bin/viewcvs.cgi/jsr166/src/jsr166e/extra/AtomicDoubleArray.java?
 * revision=1.5 (Modified to adapt to guava coding conventions and to use AtomicLongArray instead of
 * sun.misc.Unsafe)
 */
...
public class AtomicDoubleArray implements java.io.Serializable {
    ...
    /**
     * Creates a new {@code AtomicDoubleArray} of the given length, with all elements initially
     * zero.
     *
    ...
    /**
     * Creates a new {@code AtomicDoubleArray} with the same length as, and all elements copied
