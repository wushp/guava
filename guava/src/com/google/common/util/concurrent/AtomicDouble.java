...
/*
 * Source:
 * http://gee.cs.oswego.edu/cgi-bin/viewcvs.cgi/jsr166/src/jsr166e/extra/AtomicDouble.java?revision=
 * 1.13 (Modified to adapt to guava coding conventions and to use AtomicLongFieldUpdater instead of
 * sun.misc.Unsafe)
 */
 ...
 * atomic variables. An {@code AtomicDouble} is used in applications such as atomic accumulation,
 * and cannot be used as a replacement for a {@link Double}. However, this class does extend {@code
 * Number} to allow uniform access by tools and utilities that deal with numerically-based classes.
 *
 * <p>
 * <a name="bitEquals"></a>This class compares primitive {@code double} values in methods such as
 * {@link #compareAndSet} by comparing their bitwise representation using
 * {@link Double#doubleToRawLongBits}, which differs from both the primitive double {@code ==}
 * operator and from {@link Double#equals}, as if implemented by:
 *
 * <pre>
 * {@code
 ...
 *
 * <p>
 * It is possible to write a more scalable updater, at the cost of giving up strict atomicity. See
 * for example
