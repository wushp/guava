 ...
 * {@code FutureTask}, {@code ListenableFutureTask} does not provide an overrideable
 * {@link FutureTask#done() done()} method. For similar functionality, call {@link #addListener}.
 *
 * <p>
 ...
 * ListeningExecutorService.submit} on a service obtained from
...
public class ListenableFutureTask<V> extends FutureTask<V> implements ListenableFuture<V> {
    // TODO(cpovirk): explore ways of making ListenableFutureTask final. There are some valid
    // reasons
