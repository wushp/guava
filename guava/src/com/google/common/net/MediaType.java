 ...
 *
 * <p>
 * For media types that take a charset the predefined constants default to UTF-8 and have a "_UTF_8"
 * suffix. To get a version without a character set, use {@link #withoutParameters}.
 *
 * @since 12.0
 *
 * @author Gregory Kick
...
public final class MediaType {
     ...
     * name within that type. The constant name should be a sensible identifier that is closest to
     * the "common name" of the media. This is often, but not necessarily the same as the subtype.
     *
    ...
    /**
     * As described in <a href="https://w3c.github.io/webvtt/#iana-text-vtt">the VTT spec</a>, this
     * is used for Web Video Text Tracks (WebVTT) files, used with the HTML5 track element.
     *
     * @since 20.0
     */
     ...
     * Image File Format</a> ({@code crw} files), a widely-used "raw image" format for cameras. It
     * is found in {@code /etc/mime.types}, e.g. in <a href=
     ...
     * <a href=
     * "http://www.adobe.com/devnet-apps/photoshop/fileformatashtml/PhotoshopFileFormats.htm"> Adobe
     * Photoshop Document Format</a> and
     ...
     *
     * <p>
     * This is a more recent replacement for the older, experimental type {@code x-photoshop}:
    ...
    /**
     * Media type for Windows Media Audio. For more information, see <a href=
     * "https://msdn.microsoft.com/en-us/library/windows/desktop/dd562994(v=vs.85).aspx">file name
     * extensions for Windows Media metafiles</a>.
     *
     * @since 20.0
     */
    ...
    /**
     * Media type for Windows Media metafiles. For more information, see <a href=
     * "https://msdn.microsoft.com/en-us/library/windows/desktop/dd562994(v=vs.85).aspx">file name
     * extensions for Windows Media metafiles</a>.
     *
     * @since 20.0
     ...
     * "http://www.iana.org/assignments/media-types/application/vnd.ms-fontobject">registered </a>
     * with the IANA.
     *
     * @since 17.0
     */
    ...
    /**
     * This is a non-standard media type, but is commonly used in serving hosted binary files as it
     * is <a href=
     * "http://code.google.com/p/browsersec/wiki/Part2#Survey_of_content_sniffing_behaviors"> known
     * not to trigger content sniffing in current browsers</a>. It <i>should not</i> be used in
     * other situations as it is not specified by any RFC and does not appear in the
     * <a href="http://www.iana.org/assignments/media-types">/IANA MIME Media Types</a> list.
     * Consider {@link #OCTET_STREAM} for binary data that is not being served to a browser.
     *
     * @since 14.0
     */
    ...
    public static final MediaType OOXML_DOCUMENT =
            createConstant(APPLICATION_TYPE, "vnd.openxmlformats-officedocument.wordprocessingml.document");
    public static final MediaType OOXML_PRESENTATION =
            createConstant(APPLICATION_TYPE, "vnd.openxmlformats-officedocument.presentationml.presentation");
     ...
     * @throws UnsupportedCharsetException if a charset value is present, but no support is
     ...
     * {@link #withParameters}. Prefer {@link #withCharset} for setting the {@code charset}
     ...
     *
     * @throws IllegalArgumentException if type or subtype is invalid or if a wildcard is used for
     *         the type, but not the subtype.
     */
