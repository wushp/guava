...
public final class UrlEscapers {
    ...
    static final String URL_PATH_OTHER_SAFE_CHARS_LACKING_PLUS = "-._~" + // Unreserved characters.
     ...
     * <a href="https://goo.gl/MplK6I">URL form parameter names and values</a>. Escaping is
     * performed with the UTF-8 character encoding. The caller is responsible for
     * <a href="https://goo.gl/9EfkM1">replacing any unpaired carriage return or line feed
     * characters with a CR+LF pair</a> on any non-file inputs before escaping them with this
     * escaper.
     *
     * <p>
     ...
     * <a href="https://goo.gl/utn6M">using the non-standard semicolon</a>, rather than the
     * ampersand, as a parameter delimiter. Nevertheless, we recommend using the ampersand unless
     * you must interoperate with systems that require semicolons.
     *
     * <p>
     * <b>Note:</b> Unlike other escapers, URL escapers produce
     * <a href="https://url.spec.whatwg.org/#percent-encode">uppercase</a> hexadecimal sequences.
     *
     */
     ...
     * non-ASCII characters, even though <a href="https://goo.gl/e7E0In">many of these are accepted
     * in modern URLs</a>. (<a href="https://goo.gl/jfVxXW">If the escaper were to leave these
