 ...
 *
 * <p>
 * This class is primarily used for creating URI escapers in {@link UrlEscapers} but can be used
...
public final class PercentEscaper extends UnicodeEscaper {
    ...
    /**
     * An array of flags where for any {@code char c} if {@code safeOctets[c]} is true then
     * {@code c} should remain unmodified in the output. If {@code c > safeOctets.length} then it
     * should be escaped.
     */
     ...
     *
     * <p>
     * Not that it is allowed, but not necessarily desirable to specify {@code %} as a safe
     * character. This has the effect of creating an escaper which has no well defined inverse but
     * it can be useful when escaping additional characters.
     *
     * @param safeChars a non null string specifying additional safe characters for this escaper
     *        (the ranges 0..9, a..z and A..Z are always safe and should not be specified here)
