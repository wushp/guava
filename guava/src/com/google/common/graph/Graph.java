 ...
 * instance of one of the built-in implementations of {@code Graph}, use the {@link GraphBuilder}
 * class:
 *
 * <pre>
 * {
 ...
 *
 * <p>
 * {@link GraphBuilder#build()} returns an instance of {@link MutableGraph}, which is a subtype of
 * {@code Graph} that provides methods for adding and removing nodes and edges. If you do not need
 * to mutate a graph (e.g. if you write a method than runs a read-only algorithm on the graph), you
 * should use the non-mutating {@link Graph} interface, or an {@link ImmutableGraph}.
 *
 * <p>
