 ...
 * instance of one of the built-in implementations of {@code ValueGraph}, use the
 ...
 * the graph), you should use the non-mutating {@link ValueGraph} interface, or an
 ...
 *
 * <p>
 * Instances of {@link ImmutableValueGraph} do not implement {@link MutableValueGraph} (obviously!)
...
public interface ValueGraph<N, V> extends BaseGraph<N> {
    ...
    /**
     * Returns a live view of this graph as a {@link Graph}. The resulting {@link Graph} will have
     * an edge connecting node A to node B if this {@link ValueGraph} has an edge connecting A to B.
     */
    Graph<N> asGraph();
     ...
     *
     * <p>
     * In an undirected graph, this is equal to {@code edgeValue(nodeV, nodeU)}.
     *
     * @throws IllegalArgumentException if there is no edge connecting {@code nodeU} to
     *         {@code nodeV}.
     */
    ...
    /**
     * Returns {@code true} iff {@code object} is a {@link ValueGraph} that has the same elements
     * and the same structural relationships as those in this graph.
     *
     * <p>
     ...
     * <li>Every edge in A and B are associated with equal {@link #edgeValue(Object, Object)
     * values}.
     * </ul>
     *
     * <p>
     * Graph properties besides {@link #isDirected() directedness} do <b>not</b> affect equality.
     * For example, two graphs may be considered equal even if one allows self-loops and the other
     * doesn't. Additionally, the order in which nodes or edges are added to the graph, and the
     ...
     * a map from each of its {@link #edges() edges} to the associated
