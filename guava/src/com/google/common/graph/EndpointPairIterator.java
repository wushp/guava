...
abstract class EndpointPairIterator<N> extends AbstractIterator<EndpointPair<N>> {
    ...
    protected N node = null; // null is safe as an initial value because graphs don't allow null
                             // nodes
     ...
     * visited twice if there is an edge connecting them. To avoid returning duplicate
     * {@link EndpointPair}s, we keep track of the nodes that we have visited. When processing
     * endpoint pairs, we skip if the "other node" is in the visited set, as shown below:
     *
     * <pre>
     * Nodes = {N1, N2, N3, N4}
     *    N2           __
