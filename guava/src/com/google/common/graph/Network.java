...
/**
 * An interface for
 * <a href="https://en.wikipedia.org/wiki/Graph_(discrete_mathematics)">graph</a>-structured data,
 ...
 * they are: {@link Graph}, {@link ValueGraph}, and {@link Network}. You should generally prefer the
 * simplest interface that satisfies your use case. See the
 * <a href="https://github.com/google/guava/wiki/GraphsExplained#choosing-the-right-graph-type">
 ...
 * (<a href="https://github.com/google/guava/wiki/GraphsExplained#definitions">definitions of
 * terms</a>):
 *
 * <ul>
 * <li>directed graphs
 ...
 *
 * <p>
 * The implementation classes that `common.graph` provides are not public, by design. To create an
 * instance of one of the built-in implementations of {@code Network}, use the
 ...
 *
 * <p>
 * {@link NetworkBuilder#build()} returns an instance of {@link MutableNetwork}, which is a subtype
 * of {@code Network} that provides methods for adding and removing nodes and edges. If you do not
 * need to mutate a graph (e.g. if you write a method than runs a read-only algorithm on the graph),
 * you should use the non-mutating {@link Network} interface, or an {@link ImmutableNetwork}.
 *
 * <p>
 ...
 *
 * <p>
 * The Guava User Guide has
 * <a href="https://github.com/google/guava/wiki/GraphsExplained#building-graph-instances">more
 ...
 * (<a href="https://github.com/google/guava/wiki/GraphsExplained">"Graphs Explained"</a>) for
...
public interface Network<N, E> {
     ...
     * treated as if collapsed into a single edge. For example, the {@link #degree(Object)} of a
     * node in the {@link Graph} view may be less than the degree of the same node in this
     * {@link Network}.
     */
    Graph<N> asGraph();
     ...
     * {@link EndpointPair#source() source node} to a {@link EndpointPair#target() target node},
     ...
     *
     * <p>
     * This is <i>not</i> the same as "all nodes reachable from {@code node} by following outgoing
    ...
    /**
     * Returns all edges in this network which can be traversed in the direction (if any) of the
     * edge to end at {@code node}.
     *
     * <p>
     ...
     *
     * <p>
     * The resulting set of edges will be parallel (i.e. have equal {@link #incidentNodes(Object)}.
     * If this network does not {@link #allowsParallelEdges() allow parallel edges}, the resulting
     * set will contain at most one edge (equivalent to
    ...
    /**
     * Returns the single edge directly connecting {@code nodeU} to {@code nodeV}, if one is
     * present.
     *
     * <p>
    ...
    /**
     * Returns {@code true} iff {@code object} is a {@link Network} that has the same elements and
     * the same structural relationships as those in this network.
     *
     * <p>
     ...
     *
     * <p>
     * Network properties besides {@link #isDirected() directedness} do <b>not</b> affect equality.
    ...
    /**
     * Returns the hash code for this network. The hash code of a network is defined as the hash
     * code of a map from each of its {@link #edges() edges} to their {@link #incidentNodes(Object)
     * incident nodes}.
     *
     * <p>
