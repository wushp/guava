...
public interface MutableNetwork<N, E> extends Network<N, E> {
     ...
     *
     * <p>
     * <b>Nodes must be unique</b>, just as {@code Map} keys must be. They must also be non-null.
     *
    ...
    /**
     * Adds {@code edge} connecting {@code nodeU} to {@code nodeV}. In an undirected network, the
     * edge will also connect {@code nodeV} to {@code nodeU}.
     *
     * <p>
     * <b>Edges must be unique</b>, just as {@code Map} keys must be. They must also be non-null.
     *
     * <p>
     * Behavior if {@code nodeU} and {@code nodeV} are not already present in this network is
     ...
     *
     * <p>
     * If {@code edge} already connects {@code nodeU} to {@code nodeV} (in the specified order if
     ...
     *     nodeU} to {@code nodeV}, or if the introduction of the edge would violate
    ...
    /**
     * Removes {@code node} if it is present; all edges incident to {@code node} will also be
     * removed.
     *
     * @return {@code true} if the network was modified as a result of this call
     */
