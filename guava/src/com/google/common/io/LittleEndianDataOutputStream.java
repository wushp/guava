...
public final class LittleEndianDataOutputStream extends FilterOutputStream implements DataOutput {
    ...
    /**
     * @deprecated The semantics of {@code writeBytes(String s)} are considered dangerous. Please
     *             use {@link #writeUTF(String s)}, {@link #writeChars(String s)} or another write
     *             method instead.
     */
    @Deprecated
    @Override
    ...
    /**
     * Writes a {@code float} as specified by {@link DataOutputStream#writeFloat(float)}, except
     * using little-endian byte order.
     *
     * @throws IOException if an I/O error occurs
     */
