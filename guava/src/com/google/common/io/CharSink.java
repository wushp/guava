...
public abstract class CharSink {
    ...
    /**
     * Writes the given lines of text to this sink with each line (including the last) terminated
     * with the operating system's default line separator. This method is equivalent to
