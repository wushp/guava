...
public final class Resources {
    ...
    /**
     * Streams lines from a URL, stopping when our callback returns false, or we have read all of
     * the lines.
     *
     * @param url the URL to read from
     * @param charset the charset used to decode the input stream; see {@link Charsets} for helpful
    ...
    /**
     * Reads all of the lines from a URL. The lines do not include line-termination characters, but
