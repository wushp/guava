 ...
 *
 * <p>
 * {@link #processBytes} will be called for each line that is read, and should return {@code false}
...
public interface ByteProcessor<T> {
     ...
     * should process the bytes from {@code buf[off]} through {@code buf[off + len - 1]}
     * (inclusive).
     *
