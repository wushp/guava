 ...
 *
 * <p>
 * <b>Note:</b> Currently the escapers provided by this class do not escape any characters outside
 * the ASCII character range. Unlike HTML escaping the XML escapers will not escape non-ASCII
 * characters to their numeric entity replacements. These XML escapers provide the minimal level of
 * escaping to ensure that the output can be safely included in a Unicode XML document.
 *
 *
 * <p>
...
public class XmlEscapers {
     ...
     *
     * <p>
     * <b>Note:</b> Double and single quotes are not escaped, so it is <b>not safe</b> to use this
     ...
     *
     * <p>
     * This escaper substitutes {@code 0xFFFD} for non-whitespace control characters and the
     ...
     *
     * <p>
     * This escaper does not treat surrogate pairs specially and does not perform Unicode validation
     * on its input.
     */
    ...
    static {
         ...
         * replaces the allowed ASCII whitespace characters with themselves and to set the minimum
         * safe character to 0x20. However this would slow down the escaping of simple strings that
         * contain \t, \n, or \r.
         */
