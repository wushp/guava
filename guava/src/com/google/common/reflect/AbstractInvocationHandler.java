 ...
 * {@link Object#hashCode} and {@link Object#toString}. For example:
 * 
 * <pre>
...
public abstract class AbstractInvocationHandler implements InvocationHandler {
     ...
     *
     * <p>
     * Unlike {@link #invoke}, {@code args} will never be null. When the method has no parameter, an
    ...
    private static boolean isProxyOfSameInterfaces(Object arg, Class<?> proxyClass) {
        return proxyClass.isInstance(arg)
                ...
                // We first check isProxyClass() so that the common case of comparing with non-proxy
                // objects
                // is efficient.
