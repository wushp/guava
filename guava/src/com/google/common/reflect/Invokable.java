...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
     ...
     * returns the return value; or calls the underlying constructor with {@code args} and returns
    ...
    @SuppressWarnings("unchecked") // The declaring class is T's raw class, or one of its
                                   // supertypes.
    @Override
    ...
    static class ConstructorInvokable<T> extends Invokable<T, T> {
        ...
        /**
         * If the class is parameterized, such as {@link java.util.ArrayList ArrayList}, this
         * returns {@code ArrayList<E>}.
         */
        @Override
        Type getGenericReturnType() {
         ...
         * constructor's. This is an arbitrary rule since no existing language spec mandates one way
         * or the other. From the declaration syntax, the class type parameter appears first, but
         * the call syntax may show up in opposite order such as {@code new <A>Foo<B>()}.
         */
        @Override
        public final TypeVariable<?>[] getTypeParameters() {
        ...
        private boolean mayNeedHiddenThis() {
            ...
            if (enclosingMethod != null) {
                ...
                // This may cause issues when an anonymous class is created inside a static
                // initializer,
                // and the class's constructor's first parameter happens to be the enclosing class.
                // In such case, we may mistakenly think that the class is within a non-static
                // context
