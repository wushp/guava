 ...
 *
 * <p>
 * <b>Note:</b> The dispatcher is orthogonal to the subscriber's {@code Executor}. The dispatcher
...
abstract class Dispatcher {
    ...
    /**
     * Returns a dispatcher that queues events that are posted reentrantly on a thread that is
     * already dispatching an event, guaranteeing that all events posted on a single thread are
     * dispatched to all subscribers in the order they are posted.
     *
     * <p>
     * When all subscribers are dispatched to using a <i>direct</i> executor (which dispatches on
    ...
    private static final class LegacyAsyncDispatcher extends Dispatcher {
        ...
        //
        // We can't really make any guarantees about the overall dispatch order for this dispatcher
        // in
        ...
        // 2. It's possible for subscribers to actually be dispatched to in a different order than
        // they
        ...
        // probably provide a stronger order guarantee, though that order would obviously be
        // different
        // in some cases.
