...
final class SubscriberRegistry {
     ...
     * and all super-classes, that are annotated with {@code @Subscribe}. The cache is shared across
     * all instances of this class; this greatly improves performance if multiple EventBus instances
    ...
    /**
     * Returns all subscribers for the given listener grouped by the type of event they subscribe
     * to.
     */
    ...
    private static final LoadingCache<Class<?>, ImmutableSet<Class<?>>> flattenHierarchyCache =
            CacheBuilder.newBuilder().weakKeys().build(new CacheLoader<Class<?>, ImmutableSet<Class<?>>>() {
