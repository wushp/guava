 ...
 *
 * <p>
 * If neither {@link #skipNulls()} nor {@link #useForNull(String)} is specified, the joining methods
 * will throw {@link NullPointerException} if any given element is null.
 *
 * <p>
 * <b>Warning: joiner instances are always immutable</b>; a configuration method such as {@code
...
public class Joiner {
     ...
     * Identical to {@link #appendTo(Appendable, Object, Object, Object...)}, except that it does
    ...
    /**
     * Returns a joiner with the same behavior as this joiner, except automatically skipping over
     * any provided null elements.
     */
    public Joiner skipNulls() {
        return new Joiner(this) {
            @Override
    ...
    /**
     * Returns a {@code MapJoiner} using the given key-value separator, and the same configuration
     * as this {@code Joiner} otherwise.
     *
     * @since 20.0
     */
     ...
     * {@code MapJoiner} method that accepts a map as input, and receive output of the form {@code
     *     key1=[A, B]&key2=C}.
     * </ul>
     *
     * @since 2.0
    ...
    public static final class MapJoiner {
        ...
        /**
         * Returns a string containing the string representation of each entry of {@code map}, using
        ...
        /**
         * Returns a string containing the string representation of each entry in {@code entries},
