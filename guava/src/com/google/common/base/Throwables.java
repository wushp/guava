...
public final class Throwables {
     ...
     * the unlikely case that you have three or more declared checked exception types, you can
     * handle them all by invoking these methods repeatedly. See usage example in
     ...
     *             combination of {@link #throwIfUnchecked} and
     *             {@code throw new RuntimeException(e)}. For background on the deprecation, read
     *             <a href="https://goo.gl/Ivn2kc">Why we deprecated
     *             {@code Throwables.propagate}</a>. This method is scheduled to be removed in July
     *             2018.
     */
    ...
    /**
     * Returns a string containing the result of {@link Throwable#toString() toString()}, followed
     * by the full, recursive stack trace of {@code throwable}. Note that you probably should not be
     * parsing the resulting string; if you need programmatic access to the stack frames, you can
     * call {@link Throwable#getStackTrace()}.
     */
    ...
    /**
     * Returns the stack trace of {@code throwable}, possibly providing slower iteration over the
     * full trace but faster iteration over parts of the trace. Here, "slower" and "faster" are
     * defined in comparison to the normal way to access the stack trace,
     * {@link Throwable#getStackTrace() throwable.getStackTrace()}. Note, however, that this
     * method's special implementation is not available for all platforms and configurations. If
     * that implementation is unavailable, this method falls back to {@code getStackTrace}. Callers
     * that require the special implementation can check its availability with
     * {@link #lazyStackTraceIsLazy()}.
     *
     * <p>
    ...
    private static List<StackTraceElement> jlaStackTrace(final Throwable t) {
        checkNotNull(t);
        /*
         * TODO(cpovirk): Consider optimizing iterator() to catch IOOBE instead of doing bounds
         * checks.
         *
    ...
    private static Object getJLA() {
        try {
             ...
             * classes and would result in compilation failure if we directly refer to these
             * classes.
             */
             ...
             * fail with a NoClassDefFoundError. Other apps might deny access to sun.misc packages.
             */
            return null;
        }
    }
    ...
    /**
     * Returns the Method that can be used to resolve an individual StackTraceElement, or null if
     * that method cannot be found (it is only to be found in fairly recent JDKs).
     */
    @GwtIncompatible // java.lang.reflect
    @Nullable
    ...
    private static Method getJlaMethod(String name, Class<?>... parameterTypes) throws ThreadDeath {
        try {
            ...
            /*
             * Either the JavaLangAccess class itself is not found, or the method is not supported
             * on the JVM.
             */
            return null;
        }
