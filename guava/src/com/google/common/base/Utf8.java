 ...
 * in Unicode 3.1. One implication of this is that it rejects
...
public final class Utf8 {
    ...
    /**
     * Returns {@code true} if {@code bytes} is a <i>well-formed</i> UTF-8 byte sequence according
     * to Unicode 6.0. Note that this is a stronger criterion than simply whether the bytes can be
    ...
    /**
     * Returns whether the given byte array slice is a well-formed UTF-8 byte sequence, as defined
     * by {@link #isWellFormed(byte[])}. Note that this can be false even when {@code
