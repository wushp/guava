 ...
 *
 * <p>
 * Stopwatch methods are not idempotent; it is an error to start or stop a stopwatch that is already
 ...
 *
 * <p>
 * <b>Warning for Android users:</b> a stopwatch with default behavior may not continue to keep time
 * while the device is asleep. Instead, create one like this:
 * 
 * <pre>
 *    {@code
 *
...
public final class Stopwatch {
     ...
     * {@link #stop()} has not been called since the last call to {@code
     * start()}.
     */
