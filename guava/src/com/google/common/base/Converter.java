 ...
 * create a "fake" converter for a unit test. It is unnecessary (and confusing) to <i>mock</i> the
 ...
 * {@link java.util.function.Function} is accepted (for example {@link java.util.stream.Stream#map
 * Stream.map}).
...
public abstract class Converter<A, B> implements Function<A, B> {
    ...
    /**
     * Returns a representation of {@code a} as an instance of type {@code B}. If {@code a} cannot
     * be converted, an unchecked exception (such as {@link IllegalArgumentException}) should be
     * thrown.
     *
    ...
    /**
     * Returns a representation of {@code b} as an instance of type {@code A}. If {@code b} cannot
     * be converted, an unchecked exception (such as {@link IllegalArgumentException}) should be
     * thrown.
     *
     * @param b the instance to convert; will never be null
     * @return the converted instance; <b>must not</b> be null
     * @throws UnsupportedOperationException if backward conversion is not implemented; this should
     *         be very rare. Note that if backward conversion is not only unimplemented but
     ...
     *
     * <p>
     * <b>Note:</b> you should not override this method. It is non-final for legacy reasons.
     */
    @CanIgnoreReturnValue
    ...
    private static final class ReverseConverter<A, B> extends Converter<B, A> implements Serializable {
         ...
         * through. So, we override the correctedDo* methods, after which the do* methods should
         * never be reached.
         */
    ...
    /**
     * Returns a converter whose {@code convert} method applies {@code secondConverter} to the
     * result of this converter. Its {@code reverse} method applies the converters in reverse order.
     *
     * <p>
    ...
    private static final class ConverterComposition<A, B, C> extends Converter<A, C> implements Serializable {
         ...
         * through (which might even differ from each other!). So, we override the correctedDo*
         * methods, after which the do* methods should never be reached.
         */
     ...
     * a {@link Converter} that it considers <i>interchangeable</i> with this one. "Interchangeable"
     * <i>typically</i> means that {@code Objects.equal(this.convert(a), that.convert(a))} is true
     * for all {@code a} of type {@code A} (and similarly for {@code reverse}). Note that a
     * {@code false} result from this method does not imply that the converters are known <i>not</i>
     ...
     * and implement its {@link #doForward} and {@link #doBackward} methods directly.
     *
     * <p>
     * These functions will never be passed {@code null} and must not under any circumstances return
     * {@code null}. If a value cannot be converted, the function should throw an unchecked
