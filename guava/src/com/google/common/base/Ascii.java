...
public final class Ascii {
     ...
     * characters which constitute a machine-sensible address or routing information. Such a
     ...
     * Such a sequence is referred to as "text." STX may be used to terminate a sequence of
    ...
    /**
     * Enquiry: A communication control character used in data communication systems as a request
     ...
     * the next printing line. (Applicable also to display devices.) Where appropriate, this
     * character may have the meaning "New Line" (NL), a format effector which controls the movement
     * of the printing point to the first printing position on the next printing line. Use of this
     * convention requires agreement between sender and recipient of data.
     *
     * @since 8.0
     */
    ...
    /**
     * Form Feed ('\f'): A format effector which controls the movement of the printing position to
    ...
    /**
     * Carriage Return ('\r'): A format effector which controls the movement of the printing
     * position to the first printing position on the same printing line. (Applicable also to
     * display devices.)
     *
     * @since 8.0
     */
    ...
    /**
     * Data Link Escape: A communication control character which will change the meaning of a
     ...
     * processing or telecommunication systems, more especially switching devices "on" or "off." (If
     * a single "stop" control is required to interrupt or turn off ancillary devices, DC4 is the
    ...
    /**
     * Transmission On: Although originally defined as DC1, this ASCII control character is now
     * better known as the XON code used for software flow control in serial communications. The
     * main use is restarting the transmission after the communication has been stopped by the XOFF
     * control code.
     *
     * @since 8.0
     */
     ...
     * information recorded on a medium. (The position of this character does not necessarily
    ...
    /**
     * File Separator: These four information separators may be used within data in optional
    ...
    /**
     * Group Separator: These four information separators may be used within data in optional
     * fashion, except that their hierarchical relationship shall be: FS is the most inclusive, then
     * GS, then RS, and US is least inclusive. (The content and length of a File, Group, Record, or
     * Unit are not specified.)
     *
    ...
    /**
     * Unit Separator: These four information separators may be used within data in optional
     * fashion, except that their hierarchical relationship shall be: FS is the most inclusive, then
     * GS, then RS, and US is least inclusive. (The content and length of a File, Group, Record, or
     * Unit are not specified.)
     *
    ...
    /**
     * Returns a copy of the input string in which all {@linkplain #isUpperCase(char) uppercase
     * ASCII characters} have been converted to lowercase. All other characters are copied without
     * modification.
     */
    ...
    /**
     * Returns a copy of the input string in which all {@linkplain #isLowerCase(char) lowercase
     * ASCII characters} have been converted to uppercase. All other characters are copied without
     * modification.
     */
     ...
     * equal, ignoring the case of any ASCII alphabetic characters between {@code 'a'} and
     * {@code 'z'} or {@code 'A'} and {@code 'Z'} inclusive.
     *
     * <p>
    ...
    private static int getAlphaIndex(char c) {
        // Fold upper-case ASCII to lower-case and make zero-indexed and unsigned (by casting to
        // char).
