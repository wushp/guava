...
public final class Functions {
    ...
    /**
     * A function equivalent to the method reference {@code Object::toString}, for users not yet
     * using Java 8. The function simply invokes {@code toString} on its argument and returns the
     * result. It throws a {@link NullPointerException} on null input.
     *
     * <p>
     ...
     *
     * <p>
     * <b>Warning:</b> as with all function types in this package, avoid depending on the specific
     ...
     *
     * <p>
     * <b>For Java 8 users:</b> use the method reference {@code Object::toString} instead. In the
     ...
     *
     * <p>
     * <b>Java 8 users:</b> if you are okay with {@code null} being returned for an unrecognized key
     * (instead of an exception being thrown), you can use the method reference {@code map::get}
     * instead.
     */
    ...
    private static class ForMapWithDefault<K, V> implements Function<K, V>, Serializable {
        ...
        @Override
        public String toString() {
            // TODO(cpovirk): maybe remove "defaultValue=" to make this look like the method call
            // does
     ...
     *
     * <p>
     * <b>Java 8 users:</b> use {@code g.compose(f)} or (probably clearer) {@code f.andThen(g)}
     * instead.
     *
    ...
    /**
     * Creates a function that returns the same boolean output as the given predicate for all
     * inputs.
     *
     * <p>
