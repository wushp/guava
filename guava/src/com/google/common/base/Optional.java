 ...
 *
 * <p>
 * A non-null {@code Optional<T>} reference can be used as a replacement for a nullable {@code T}
 ...
 *
 * <p>
 * <b>Comparison to {@code java.util.Optional} (JDK 8 and higher):</b> A new {@code Optional} class
 * was added for Java 8. The two classes are extremely similar, but incompatible (they cannot share
 * a common supertype). <i>All</i> known differences are listed either here or with the relevant
 * methods below.
 *
 * <ul>
 ...
 *
 * <p>
 * <b>There are no plans to deprecate this class in the foreseeable future.</b> However, we do
...
public abstract class Optional<T> implements Serializable {
     ...
     *
     * <p>
     * <b>Comparison to {@code java.util.Optional}:</b> this method is equivalent to Java 8's
     * {@code Optional.empty}.
     */
     ...
     * that reference; otherwise returns {@link Optional#absent}.
     *
     * <p>
     * <b>Comparison to {@code java.util.Optional}:</b> this method is equivalent to Java 8's
     ...
     *
     * <p>
     * <b>Comparison to {@code java.util.Optional}:</b> when the value is absent, this method throws
     * {@link IllegalStateException}, whereas the Java 8 counterpart throws
     ...
     *         {@code false}); depending on this <i>specific</i> exception type (over the more
     ...
     *
     * <p>
     * <b>Comparison to {@code java.util.Optional}:</b> this method has no equivalent in Java 8's
     ...
     *
     * <p>
     * <b>Comparison to {@code java.util.Optional}:</b> this class leaves the specific choice of
     ...
     *
     * <p>
     * <b>Comparison to {@code java.util.Optional}:</b> this class leaves the specific string
