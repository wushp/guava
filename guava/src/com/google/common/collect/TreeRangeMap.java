...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    ...
    private static <K extends Comparable, V> Range<K> coalesce(Range<K> range, V value,
            @Nullable Map.Entry<Cut<K>, RangeMapEntry<K, V>> entry) {
    ...
    public void remove(Range<K> rangeToRemove) {
        ...
        /*
         * The comments for this method will use [ ] to indicate the bounds of rangeToRemove and ( )
         * to indicate the bounds of ranges in the range map.
         */
            ...
            return new SubRangeMapAsMap() {
                ...
                Iterator<Entry<Range<K>, V>> entryIterator() {
                    ...
                    final Iterator<RangeMapEntry<K, V>> backingItr =
                            entriesByLowerBound.headMap(subRange.upperBound, false).descendingMap().values().iterator();
