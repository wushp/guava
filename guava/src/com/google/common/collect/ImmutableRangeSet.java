...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
     ...
     *
     * <p>
     * This is the smallest {@code RangeSet} which encloses each of the specified ranges. Duplicate
    ...
    public ImmutableSet<Range<C>> asDescendingSetOfRanges() {
        ...
        return new RegularImmutableSortedSet<Range<C>>(ranges.reverse(), Range.RANGE_LEX_ORDERING.reverse());
    }
     ...
     *
     * <p>
     * <b>Note:</b> {@code a.asSet(d).equals(b.asSet(d))} does not imply {@code a.equals(b)}! For
     * example, {@code a} and {@code b} could be {@code [2..4]} and {@code (1..5)}, or the empty
     * ranges {@code [3..3)} and {@code [4..4)}.
     *
     * <p>
     * <b>Warning:</b> Be extremely careful what you do with the {@code asSet} view of a large range
     * set (such as {@code ImmutableRangeSet.of(Range.greaterThan(0))}). Certain operations on such
     * a set can be performed efficiently, but others (such as {@link Set#hashCode} or
     ...
     *
     * @throws IllegalArgumentException if neither this range nor the domain has a lower bound, or
     *         if neither has an upper bound
     */
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        /**
         * Add the specified range to this builder. Adjacent ranges are permitted and will be
        ...
        /**
         * Add all ranges from the specified range set to this builder. Adjacent ranges are
         * permitted and will be merged, but overlapping ranges will cause an exception when
        ...
        /**
         * Add all of the specified ranges to this builder. Adjacent ranges are permitted and will
         * be merged, but overlapping ranges will cause an exception when {@link #build()} is
         * called.
         *
