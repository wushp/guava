 ...
 * <a href= "https://github.com/google/guava/wiki/NewCollectionTypesExplained#bimap"> {@code BiMap}
 * </a>.
 *
...
public final class HashBiMap<K, V> extends IteratorBasedAbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    /**
     * Constructs a new bimap containing initial values from {@code map}. The bimap is created with
    ...
    /**
     * Finds and removes {@code entry} from the bucket linked lists in both the key-to-value
     * direction and the value-to-key direction.
     */
    ...
    /**
     * @serialData the number of entries, first key, first value, second key, second value, and so
     *             on.
     */
