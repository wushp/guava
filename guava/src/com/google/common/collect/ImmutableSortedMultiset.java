...
public abstract class ImmutableSortedMultiset<E> extends ImmutableSortedMultisetFauxverideShim<E>
     ...
     *
     * <p>
     * <b>Warning:</b> {@code comparator} should be <i>consistent with {@code
     ...
     * occurrence in encounter order appears in the resulting multiset, with count equal to the sum
     * of the outputs of {@code countFunction.applyAsInt(t)} for each {@code t} mapped to that
     * element.
     *
     * @since 22.0
     */
    public static <T, E> Collector<T, ?, ImmutableSortedMultiset<E>> toImmutableSortedMultiset(
        ...
        return Collector.of(() -> TreeMultiset.create(comparator),
                (multiset, t) -> multiset.add(checkNotNull(elementFunction.apply(t)), countFunction.applyAsInt(t)),
                (multiset1, multiset2) -> {
     ...
     * returns an {@code ImmutableSortedMultiset<Multiset<String>>} containing one element (the
     * given multiset itself).
     *
     * <p>
    ...
    public static <E> ImmutableSortedMultiset<E> copyOf(Comparator<? super E> comparator,
        ...
        if (elements instanceof ImmutableSortedMultiset) {
            @SuppressWarnings("unchecked") // immutable collections are always safe for covariant
                                           // casts
    ...
    public ImmutableSortedMultiset<E> descendingMultiset() {
        ...
        if (result == null) {
            return descendingMultiset = this.isEmpty() ? emptyMultiset(Ordering.from(comparator()).reverse())
     ...
     * <a href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6468354">bug 6468354</a>.
     */
     ...
     *             new ImmutableSortedMultiset.Builder<Bean>(colorComparator()).addCopies(Bean.COCOA, 4)
     *                     .addCopies(Bean.GARDEN, 6).addCopies(Bean.RED, 8).addCopies(Bean.BLACK_EYED, 10).build();
     * }
     * </pre>
     *
     * <p>
    ...
    public static class Builder<E> extends ImmutableMultiset.Builder<E> {
        ...
        /**
         * Returns a newly-created {@code ImmutableSortedMultiset} based on the contents of the
         * {@code
         * Builder}.
         */
        @Override
