 ...
 * equivalents with deprecated, exception-throwing versions. See
 * {@link ImmutableSortedSetFauxverideShim} for details.
 *
 * @author Chris Povirk
 */
@GwtIncompatible
abstract class ImmutableSortedMapFauxverideShim<K, V> extends ImmutableMap<K, V> {
     ...
     * type-safety, instead. This method exists only to hide {@link ImmutableMap#toImmutableMap}
     ...
     * instead. This method exists only to hide {@link ImmutableMap#builder} from consumers of
