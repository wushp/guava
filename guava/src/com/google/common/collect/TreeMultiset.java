...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
     ...
     *
     * <p>
     * The type specification is {@code <E extends Comparable>}, instead of the more specific
     ...
     * {@code comparator.compare(e1, e2)} must not throw a {@code ClassCastException} for any
     * elements {@code e1} and {@code e2} in the multiset. If the user attempts to add an element to
     * the multiset that violates this constraint, the {@code add(Object)} call will throw a {@code
     * ClassCastException}.
     *
    ...
    private static final class AvlNode<E> extends Multisets.AbstractEntry<E> {
        ...
        AvlNode<E> add(Comparator<? super E> comparator, @Nullable E e, int count, int[] result) {
            /*
             * It speeds things up considerably to unconditionally add count to totalCount here, but
             * that destroys failure atomicity in the case of count overflow. =(
             */
            int cmp = comparator.compare(e, elem);
            if (cmp < 0) {
    ...
    /**
     * @serialData the comparator, the number of distinct elements, the first element, its count,
