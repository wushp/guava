...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
     ...
     *
     * <p>
     * For streams with {@linkplain java.util.stream#Ordering defined encounter order}, that order
     ...
     *
     *     static final Multimap<Character, String> FIRST_LETTER_MULTIMAP =
     *             new ImmutableListMultimap.Builder<Character, String>().put('b', "anana")
     *                     .putAll('a', "pple", "sparagus").putAll('c', "arrot", "herry").build();
     * }
     * </pre>
     *
     * @since 21.0
     ...
     * resulting {@code Multimap}, in the encounter order of the stream and the encounter order of
    ...
    public static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> flatteningToImmutableListMultimap(
        ...
        return Collectors.collectingAndThen(
                Multimaps.flatteningToMultimap(input -> checkNotNull(keyFunction.apply(input)),
     ...
     *             new ImmutableListMultimap.Builder<String, Integer>().put("one", 1).putAll("several", 1, 2, 3)
    ...
    public static final class Builder<K, V> extends ImmutableMultimap.Builder<K, V> {
         ...
         * {@link ImmutableListMultimap#builder}.
         */
        public Builder() {}
     ...
     * multimap}. The generated multimap's key and value orderings correspond to the iteration
     * ordering of the {@code multimap.asMap()} view.
     *
     * <p>
    ...
    /**
     * Returns an immutable list of the values for the given key. If no mappings in the multimap
     * have the provided key, an empty immutable list is returned. The values are in the same order
     * as the parameters used to build this multimap.
     */
    @Override
     ...
     *
     * <p>
     * Because an inverse of a list multimap can contain multiple pairs with the same key and value,
     * this method returns an {@code
     * ImmutableListMultimap} rather than the {@code ImmutableMultimap} specified in the
     * {@code ImmutableMultimap} class.
     *
     * @since 11.0
     */
    @Override
