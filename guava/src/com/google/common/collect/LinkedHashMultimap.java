 ...
 * asMap} iterate through the keys in the order they were first added to the multimap. Similarly,
 * {@code get}, {@code removeAll}, and {@code
 * replaceValues} return collections that iterate through the values in the order they were added.
 * The collections generated by {@code entries} and {@code values} iterate across the key-value
...
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
    ...
    /**
     * Constructs a {@code LinkedHashMultimap} with the same mappings as the specified multimap. If
     * a key-value mapping appears multiple times in the input multimap, it only appears once in the
     * constructed multimap. The new multimap has the same {@link Multimap#entries()} iteration
     ...
     *
     * <p>
     * The iterator generated by the returned set traverses the entries in the order they were added
     * to the multimap.
     *
     * <p>
    ...
    final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        public void forEach(Consumer<? super V> action) {
            checkNotNull(action);
            for (ValueSetLink<K, V> entry = firstEntry; entry != ValueSet.this; entry =
        ...
        public boolean contains(@Nullable Object o) {
            ...
            for (ValueEntry<K, V> entry = hashTable[smearedHash & mask()]; entry != null; entry =
                    entry.nextInValueBucket) {
        ...
        public boolean remove(@Nullable Object o) {
            ...
            for (ValueEntry<K, V> entry = hashTable[bucket]; entry != null; prev = entry, entry =
                    entry.nextInValueBucket) {
                if (entry.matchesValue(o, smearedHash)) {
                    if (prev == null) {
