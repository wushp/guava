 ...
 *
 * <p>
 * <b>For Java 8 users:</b> Because this is an abstract class, not an interface, you can't use a
...
public abstract class TreeTraverser<T> {
     ...
     * children. This is useful if the function instance already exists, or so that you can supply a
     * lambda expressions. If those circumstances don't apply, you probably don't need to use this;
     * subclass {@code TreeTraverser} and implement its {@link #children} method directly.
     *
     * @since 20.0
     */
