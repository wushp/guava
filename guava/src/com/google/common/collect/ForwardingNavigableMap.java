 ...
 * override one or more methods to modify the behavior of the backing map as desired per the
 * <a href="http://en.wikipedia.org/wiki/Decorator_pattern">decorator pattern</a>.
 *
 * <p>
 * <b>Warning:</b> The methods of {@code ForwardingNavigableMap} forward <i>indiscriminately</i> to
...
public abstract class ForwardingNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V> {
    ...
    /**
     * A sensible definition of {@link #ceilingKey} in terms of {@code ceilingEntry}. If you
     * override {@code ceilingEntry}, you may wish to override {@code ceilingKey} to forward to this
     * implementation.
     */
     ...
     * {@code lastEntry}, you may wish to override {@code lastKey} to forward to this
     * implementation.
     */
     ...
     * {@code entrySet} of {@code descendingMap}. If you override {@code descendingMap}, you may
     ...
     * this {@code NavigableMap}. In many cases, you may wish to override
     * {@link ForwardingNavigableMap#navigableKeySet} to forward to this implementation or a
     * subclass thereof.
     *
     * @since 12.0
     */
