 ...
 * {@link Set} of values, while {@link #entries} returns a {@code
 * Set} of map entries. Though the method signature doesn't say so explicitly, the map returned by
 ...
 *
 * <p>
 * Since the value collections are sets, the behavior of a {@code SetMultimap} is not specified if
 * key <em>or value</em> objects already present in the multimap change in a manner that affects
 * {@code equals} comparisons. Use caution if mutable objects are used as keys or values in a
 * {@code SetMultimap}.
 *
 * <p>
...
public interface SetMultimap<K, V> extends Multimap<K, V> {
     ...
     *
     * <p>
     * <b>Note:</b> The returned map's values are guaranteed to be of type {@link Set}. To obtain
     * this map with the more specific generic type {@code Map<K, Set<V>>}, call
