 ...
 * {@code findFirst()} or {@code iterator()} is invoked. (Even though {@code Stream} contains all
 * the right method <i>signatures</i> to implement {@link Iterable}, it does not actually do so, to
 * avoid implying repeat-iterability.) {@code FluentIterable}, on the other hand, is multiple-use,
 * and does implement {@link Iterable}.
...
public abstract class FluentIterable<E> implements Iterable<E> {
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> {@link Collection#stream} if {@code iterable} is a
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> {@link java.util.stream.Stream#of(Object[])
     * Stream.of(T...)}.
     *
     ...
     * {@code FluentIterable} has obviated the need to explicitly convert to a
     * {@code FluentIterable}.
     *
    ...
    /**
     * Returns a fluent iterable that combines three iterables. The returned iterable has an
     * iterator that traverses the elements in {@code a}, followed by the elements in {@code b},
     * followed by the elements in {@code c}. The source iterators are not polled until necessary.
     *
     * <p>
     * The returned iterable's iterator supports {@code remove()} when the corresponding input
     * iterator supports it.
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> use nested calls to {@link Stream#concat}, or see the
     ...
     * the elements in {@code c}, followed by the elements in {@code d}. The source iterators are
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> to concatenate an arbitrary number of streams, use {@code
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> {@code stream.collect(Collectors.joining(", ", "[", "]"))}
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> {@code stream.anyMatch(Predicate.isEqual(target))}.
     */
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> if the source iterable has only a single element {@code
     * e}, use {@code Stream.generate(() -> e)}. Otherwise, collect your stream into a collection
    ...
    /**
     * Returns a fluent iterable whose iterators traverse first the elements of this fluent
     * iterable, followed by those of {@code other}. The iterators are not polled until necessary.
     *
     * <p>
    ...
    /**
     * Returns a fluent iterable whose iterators traverse first the elements of this fluent
     * iterable, followed by {@code elements}.
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> {@code Stream.concat(thisStream, Stream.of(elements))}.
     *
     * @since 18.0
     */
    @Beta
    ...
    /**
     * Returns {@code true} if every element in this fluent iterable satisfies the predicate. If
     * this fluent iterable is empty, {@code true} is returned.
     *
     * <p>
    ...
    /**
     * Applies {@code function} to each element of this fluent iterable and returns a fluent
     * iterable with the concatenated combination of results. {@code function} returns an Iterable
     * of results.
     *
     * <p>
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> {@link Stream#flatMap} (using a function that produces
    ...
    public final Optional<E> last() {
        ...
        /*
         * TODO(kevinb): consider whether this "optimization" is worthwhile. Users with SortedSets
         * tend to know they are SortedSets and probably would not call this method.
         */
     ...
     *
     * <p>
     * Modifications to this fluent iterable before a call to {@code iterator()} are reflected in
    ...
    /**
     * Creates a fluent iterable with the first {@code size} elements of this fluent iterable. If
     * this fluent iterable does not contain that many elements, the returned fluent iterable will
     * have the same behavior as this fluent iterable. The returned fluent iterable's iterator
     * supports {@code
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> pass {@link ImmutableList#toImmutableList} to {@code
     * stream.collect()}.
     *
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> pass {@link ImmutableSet#toImmutableSet} to {@code
     * stream.collect()}.
     *
     ...
     * {@code comparator.compare(x, y) == 0}) removed. To produce an {@code ImmutableSortedSet}
     * sorted by its natural ordering, use {@code toSortedSet(Ordering.natural())}.
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> pass {@link ImmutableSortedSet#toImmutableSortedSet} to
     * {@code stream.collect()}.
     *
    ...
    /**
     * Returns an {@code ImmutableMultiset} containing all of the elements from this fluent
     * iterable.
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> pass {@link ImmutableMultiset#toImmutableMultiset} to
     * {@code
     * stream.collect()}.
     *
     * @since 19.0
     ...
     * specified function to each item in this {@code FluentIterable} of values. Each element of
     * this iterable will be stored as a value in the resulting multimap, yielding a multimap with
     * the same size as this iterable. The key used to store that value in the multimap will be the
     * result of calling the function on that value. The resulting multimap is created as an
     * immutable snapshot. In the returned multimap, keys appear in the order they are first
     * encountered, and the values corresponding to each key appear in the same order as they are
     * encountered.
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> {@code stream.collect(Collectors.groupingBy(keyFunction))}
     * behaves similarly, but returns a mutable {@code Map<K, List<E>>} instead, and may not
     ...
     * map whose key is the result of applying {@code keyFunction} to that value. These entries
     * appear in the same order as they appeared in this fluent iterable. Example usage:
     *
     * <pre>
     * {@code
     ...
     * {@code stream.toArray()}; if {@code type} is a class literal such as {@code MyType.class},
     * use {@code stream.toArray(MyType[]::new)}. Otherwise use {@code stream.toArray(
    ...
    /**
     * Copies all the elements from this fluent iterable to {@code collection}. This is equivalent
     * to calling {@code Iterables.addAll(collection, this)}.
     *
     * <p>
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> {@code joiner.join(stream.iterator())}, or, if you are not
     ...
     *
     * <p>
     * <b>{@code Stream} equivalent:</b> {@code stream.skip(position).findFirst().get()} (but note
     ...
     * {@link Collection#stream} on a collecion).
     *
     * <p>
     * <b>Note:</b> the earlier in the chain you can switch to {@code Stream} usage (ideally not
     * going through {@code FluentIterable} at all), the more performant and idiomatic your code
     * will be. This method is a transitional aid, to be used only when really necessary.
     *
     * @since 21.0
     */
