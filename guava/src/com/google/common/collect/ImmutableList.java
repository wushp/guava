...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
     ...
     * {@link Collections#emptyList}, and is preferable mainly for consistency and maintainability
     * of your code.
     */
     ...
     * strings in {@code list}, while ImmutableList.of(list)} returns an
     * {@code ImmutableList<List<String>>} containing one element (the given list itself).
     *
     * <p>
    ...
    public static <E> ImmutableList<E> copyOf(E[] elements) {
        return (elements.length == 0) ? ImmutableList.<E>of() : construct(elements.clone());
    }

    /**
     * Returns an immutable list containing the given elements, sorted according to their natural
     * order. The sorting algorithm used is stable, so elements that compare as equal will stay in
     ...
     *
     * <p>
     * <b>Java 8 users:</b> If you want to convert a {@link java.util.stream.Stream} to a sorted
    ...
    /**
     * Views the array as an immutable list. Copies if the specified range does not cover the
     * complete array. Does not check for nulls.
     */
     ...
     * fromIndex} and {@code toIndex} are equal, the empty immutable list is returned.)
     */
    @Override
     ...
     * toIndex - fromIndex > 1}, after index validation has already been performed.
     */
    ...
    /*
     * Serializes ImmutableLists as their logical contents. This ensures that implementation types
     * do not leak into the serialized representation.
     */
     ...
     *             new ImmutableList.Builder<Color>().addAll(WEBSAFE_COLORS).add(new Color(0, 191, 255)).build();
     * }
     * </pre>
     *
     * <p>
