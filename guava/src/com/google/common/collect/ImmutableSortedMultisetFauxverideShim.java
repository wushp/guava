...
abstract class ImmutableSortedMultisetFauxverideShim<E> extends ImmutableMultiset<E> {
     ...
     * properly typed "<E extends Comparable<E>> copyOf(Iterable<E>)" in ImmutableSortedMultiset
     * (and likewise for the Iterator equivalent). However, due to a change in Sun's interpretation
     * of the JLS (as described at http://bugs.sun.com/view_bug.do?bug_id=6182950), the OpenJDK 7
     ...
     * definition of copyOf() here, and the definition in ImmutableSortedMultiset matches that in
     * ImmutableMultiset.
     *
