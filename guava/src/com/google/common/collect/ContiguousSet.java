 ...
 *
 * <p>
 * <b>Warning:</b> Be extremely careful what you do with conceptually large instances (such as
 * {@code ContiguousSet.create(Range.greaterThan(0), DiscreteDomain.integers()}). Certain operations
 * on such a set can be performed efficiently, but others (such as {@link Set#hashCode} or
...
public abstract class ContiguousSet<C extends Comparable> extends ImmutableSortedSet<C> {
     ...
     * is requested for a domain minimum or maximum. For example, if {@code set} was created from
     * the range {@code [1..Integer.MAX_VALUE]} then {@code set.range(CLOSED, OPEN)} must return
     * {@code [1..∞)}.
     *
     * @throws NoSuchElementException if this set is empty
     */
