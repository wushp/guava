...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    static final ImmutableMap<Object, Object> EMPTY =
            new RegularImmutableMap<Object, Object>((Entry<Object, Object>[]) ImmutableMap.EMPTY_ENTRY_ARRAY, null, 0);
    ...
    static <V> V get(@Nullable Object key, @Nullable ImmutableMapEntry<?, V>[] keyTable, int mask) {
        ...
        for (ImmutableMapEntry<?, V> entry = keyTable[index]; entry != null; entry = entry.getNextInKeyBucket()) {
            ...
            /*
             * Assume that equals uses the == optimization when appropriate, and that it would check
             * hash codes as an optimization when appropriate. If we did these things, it would just
             * make things worse for the most performance-conscious users.
             */
