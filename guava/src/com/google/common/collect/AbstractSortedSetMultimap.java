...
/**
 * Basic implementation of the {@link SortedSetMultimap} interface. It's a wrapper around
 * {@link AbstractMapBasedMultimap} that converts the returned collections into sorted sets. The
 * {@link #createCollection} method must return a {@code SortedSet}.
 *
 * @author Jared Levy
 */
@GwtCompatible
abstract class AbstractSortedSetMultimap<K, V> extends AbstractSetMultimap<K, V> implements SortedSetMultimap<K, V> {
     ...
     *
     * <p>
     * Though the method signature doesn't say so explicitly, the returned map has {@link SortedSet}
     * values.
     */
    @Override
