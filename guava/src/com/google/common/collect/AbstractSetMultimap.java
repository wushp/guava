...
/**
 * Basic implementation of the {@link SetMultimap} interface. It's a wrapper around
 * {@link AbstractMapBasedMultimap} that converts the returned collections into {@code Sets}. The
...
abstract class AbstractSetMultimap<K, V> extends AbstractMapBasedMultimap<K, V> implements SetMultimap<K, V> {
     ...
     *
     * <p>
     * Though the method signature doesn't say so explicitly, the returned map has {@link Set}
     * values.
     */
    @Override
     ...
     *         the multimap already contained the key-value pair
     */
    @CanIgnoreReturnValue
    @Override
