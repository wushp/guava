 ...
 * working with collections. It is a part of the open-source
 ...
 * <dd>An extension of {@link java.util.Map} that guarantees the uniqueness of its values as well as
 * that of its keys. This is sometimes called an "invertible map," since the restriction on values
 * enables it to support an {@linkplain com.google.common.collect.BiMap#inverse inverse view} --
 ...
 * {@link java.util.List}, yet has order-independent equality like a {@link java.util.Set}. One
 * typical use for a multiset is to represent a histogram.
 *
 * <dt>{@link com.google.common.collect.Multimap}
 * <dd>A new type, which is similar to {@link java.util.Map}, but may contain multiple entries with
 * the same key. Some behaviors of {@link com.google.common.collect.Multimap} are left unspecified
 * and are provided only by the subtypes mentioned below.
 *
 ...
 * equality</i> as defined by {@link com.google.common.collect.ListMultimap#equals(Object)}. {@code
 *     ListMultimap} takes its name from the fact that the
 * {@linkplain com.google.common.collect.ListMultimap#get collection of values} associated with a
 * given key fulfills the {@link java.util.List} contract.
 *
 ...
 * {@code SetMultimap}, each must map to a different value. {@code SetMultimap} takes its name from
 * the fact that the {@linkplain com.google.common.collect.SetMultimap#get collection of values}
 * associated with a given key fulfills the {@link java.util.Set} contract.
 *
 * <dt>{@link com.google.common.collect.SortedSetMultimap}
 * <dd>An extension of {@link com.google.common.collect.SetMultimap} for which the
 * {@linkplain com.google.common.collect.SortedSetMultimap#get collection values} associated with a
 * given key is a {@link java.util.SortedSet}.
 *
