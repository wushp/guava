...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
     ...
     *
     * <p>
     * This is the smallest {@code RangeSet} which encloses each of the specified ranges. An element
     * will be contained in this {@code RangeSet} if and only if it is contained in at least one
     * {@code Range} in {@code ranges}.
     *
     * @since 21.0
     */
    ...
    static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        /**
         * upperBoundWindow represents the headMap/subMap/tailMap view of the entire "ranges by
         * upper bound" map; it's a constraint on the *keys*, and does not affect the values.
         */
    ...
    private static final class ComplementRangesByLowerBound<C extends Comparable<?>>
         ...
         * "complement ranges by lower bound" map; it's a constraint on the *keys*, and does not
         * affect the values.
         */
        ...
        Iterator<Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
             ...
             * lower bound inside complementLowerBoundWindow.
             *
             ...
             */
            Cut<C> startingPoint =
                    complementLowerBoundWindow.hasUpperBound() ? complementLowerBoundWindow.upperEndpoint()
                            : Cut.<C>aboveAll();
    ...
    private static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>>
            extends AbstractNavigableMap<Cut<C>, Range<C>> {
        /**
         * lowerBoundWindow is the headMap/subMap/tailMap view; it only restricts the keys, and does
