...
public final class EnumBiMap<K extends Enum<K>, V extends Enum<V>> extends AbstractBiMap<K, V> {
     ...
     * specified map must contain at least one mapping, in order to determine the key and value
     * types.
     *
    ...
    /**
     * @serialData the key class, value class, number of entries, first key, first value, second
