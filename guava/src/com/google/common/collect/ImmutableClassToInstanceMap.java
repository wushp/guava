...
public final class ImmutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B>
     ...
     *             new ImmutableClassToInstanceMap.Builder<Handler>().put(FooHandler.class, new FooHandler())
     *                     .put(BarHandler.class, new SubBarHandler()).put(Handler.class, new QuuxHandler()).build();
     * }
     * </pre>
     *
     * <p>
     * After invoking {@link #build()} it is still possible to add more entries and build again.
    ...
    public static final class Builder<B> {
         ...
         * @throws ClassCastException if any value is not an instance of the type specified by its
         *         key
         */
        @CanIgnoreReturnValue
