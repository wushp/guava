...
public abstract class HashCode {
    ...
    /**
     * Returns whether this {@code HashCode} and that {@code HashCode} have the same value, given
     * that they have the same number of bits.
     */
     ...
     * it must be handed-off so as to preserve the immutability contract of {@code HashCode}.
     */
     ...
     * must be at least 2 characters long, and contain only valid, lower-cased hexadecimal
     * characters.
     *
     * <p>
     ...
     *
     * <p>
     * <b>Security note:</b> this method uses a constant-time (not short-circuiting) implementation
