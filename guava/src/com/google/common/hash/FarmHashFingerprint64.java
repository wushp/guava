 ...
 *
 * <p>
 * Note to maintainers: This implementation relies on signed arithmetic being bit-wise equivalent to
 * unsigned arithmetic in all cases except:
 *
 * <ul>
...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength65Plus(byte[] bytes, int offset, int length) {
        final int seed = 81;
        // For strings over 64 bytes we loop. Internal state consists of 56 bytes: v, w, x, y, and
        // z.
        long x = seed;
