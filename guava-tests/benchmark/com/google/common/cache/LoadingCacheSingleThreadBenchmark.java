...
public class LoadingCacheSingleThreadBenchmark {
    ...
    void setUp() {
        ...
        cache = CacheBuilder.newBuilder().concurrencyLevel(segments).maximumSize(maximumSize)
    ...
    private int nextRandomKey() {
         ...
         * uniformly-distributed random integer, then truncates any fractional part, so higher
         * integers would appear (in this case linearly) more often than lower ones.
         */
