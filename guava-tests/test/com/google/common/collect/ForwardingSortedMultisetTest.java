...
public class ForwardingSortedMultisetTest extends TestCase {
    ...
    public static Test suite() {
        ...
        }).named("ForwardingSortedMultiset with standard impls").withFeatures(CollectionSize.ANY,
                CollectionFeature.KNOWN_ORDER, CollectionFeature.GENERAL_PURPOSE, CollectionFeature.ALLOWS_NULL_QUERIES)
                .createTestSuite());
    ...
    public void testForwarding() {
        new ForwardingWrapperTester().testForwarding(SortedMultiset.class,
