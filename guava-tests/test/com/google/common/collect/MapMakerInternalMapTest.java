...
public class MapMakerInternalMapTest extends TestCase {
    ...
    private static <K, V> MapMakerInternalMap<K, V, ? extends InternalEntry<K, V, ?>, ? extends Segment<K, V, ?, ?>> makeMap(
            MapMaker maker) {
    ...
    private static void checkConcurrencyLevel(int concurrencyLevel, int segmentCount) {
        MapMakerInternalMap<Object, Object, ?, ?> map = makeMap(createMapMaker().concurrencyLevel(concurrencyLevel));
    ...
    private static void checkInitialCapacity(int concurrencyLevel, int initialCapacity, int segmentSize) {
        MapMakerInternalMap<Object, Object, ?, ?> map =
                makeMap(createMapMaker().concurrencyLevel(concurrencyLevel).initialCapacity(initialCapacity));
