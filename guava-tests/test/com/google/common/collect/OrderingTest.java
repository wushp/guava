...
public class OrderingTest extends TestCase {
    ...
    public void testComplicatedOrderingExample() {
        ...
        assertThat(sorted).containsExactly(Lists.newArrayList(nullInt, nullInt), Lists.newArrayList(nullInt),
                ...
                Lists.newArrayList(1), Lists.newArrayList(2), Lists.newArrayList(), null).inOrder();
    }
    ...
    public void testCompound_static() {
        Comparator<String> comparator = Ordering.compound(
                ImmutableList.of(byCharAt(0), byCharAt(1), byCharAt(2), byCharAt(3), byCharAt(4), byCharAt(5)));
    ...
    public void testOnResultOf_natural() {
        ...
        new EqualsTester()
                .addEqualityGroup(comparator, Ordering.natural().onResultOf(StringLengthFunction.StringLength))
    ...
    public void testLexicographical() {
        ...
        new EqualsTester().addEqualityGroup(lexy, ordering.lexicographical())
                .addEqualityGroup(numberOrdering.lexicographical()).addEqualityGroup(Ordering.natural()).testEquals();
    }
    ...
    public void testGreatestOfIterable_simple() {
        /*
         * If greatestOf() promised to be implemented as reverse().leastOf(), this test would be
         * enough. It doesn't... but we'll cheat and act like it does anyway. There's a comment
         * there to remind us to fix this if we change it.
         */
     ...
     * creating the alternate Ordering, and providing a List that is known to be ordered, based on
     * an input List known to be ordered according to the input Ordering.
     */
    private enum OrderingMutation {
        ...
        COMPOUND_THIS_WITH_NATURAL {
            ...
            <T> Scenario<?> mutate(Scenario<T> scenario) {
                ...
                Ordering<Composite<T>> ordering =
                        scenario.ordering.onResultOf(Composite.<T>getValueFunction()).compound(Ordering.natural());
        ...
        COMPOUND_NATURAL_WITH_THIS {
            ...
            <T> Scenario<?> mutate(Scenario<T> scenario) {
                ...
                Ordering<Composite<T>> ordering =
                        Ordering.natural().compound(scenario.ordering.onResultOf(Composite.<T>getValueFunction()));
                return new Scenario<Composite<T>>(ordering, composites, new Composite[0]);
            }
        },
        LEXICOGRAPHICAL {
