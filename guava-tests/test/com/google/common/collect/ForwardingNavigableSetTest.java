...
public class ForwardingNavigableSetTest extends TestCase {
    ...
    public static Test suite() {
        ...
        }).named("ForwardingNavigableSet[SafeTreeSet[Ordering.natural.nullsFirst]]" + " with standard implementations")
                .withFeatures(CollectionSize.ANY, CollectionFeature.KNOWN_ORDER, CollectionFeature.GENERAL_PURPOSE,
    ...
    public void testForwarding() {
        new ForwardingWrapperTester().testForwarding(NavigableSet.class, new Function<NavigableSet, NavigableSet>() {
            @Override
    ...
    public void testEquals() {
        ...
        new EqualsTester().addEqualityGroup(set1, wrap(set1), wrap(set1)).addEqualityGroup(set2, wrap(set2))
                .testEquals();
    }
