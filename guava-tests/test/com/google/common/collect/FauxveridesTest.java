...
public class FauxveridesTest extends TestCase {
     ...
     * ImmutableSorted{Set,Map}.copyOf(), whose type parameters we are unable to restrict (see
     * ImmutableSortedSetFauxverideShim).
     */

    public void testImmutableSortedMapCopyOfMap() {
        Map<Object, Object> original = ImmutableMap.of(new Object(), new Object(), new Object(), new Object());
    ...
    private static final class TypeSignature {
        ...
        TypeSignature(TypeVariable<Method>[] parameters) {
            parameterSignatures =
                    transform(Arrays.asList(parameters), new Function<TypeVariable<?>, TypeParameterSignature>() {
                        @Override
    ...
    private static final class TypeParameterSignature {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof TypeParameterSignature) {
                ...
                /*
                 * The name is here only for display purposes; <E extends Number> and <T extends
        ...
        @Override
        public String toString() {
            return (bounds.equals(ImmutableList.of(Object.class))) ? name : name + " extends " + getTypesString(bounds);
        }
    }
