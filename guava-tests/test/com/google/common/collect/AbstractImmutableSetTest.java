...
public abstract class AbstractImmutableSetTest extends TestCase {
    ...
    protected abstract Set<String> of(String e1, String e2, String e3, String e4, String e5);

    protected abstract Set<String> of(String e1, String e2, String e3, String e4, String e5, String e6, String... rest);
    ...
    public void testBuilderWithNonDuplicateElements() {
        ImmutableSet<String> set =
                this.<String>builder().add("a").add("b", "c").add("d", "e", "f").add("g", "h", "i", "j").build();
     ...
     * number of elements. Tests using this method might fail in GWT because the GWT emulations
     * might count on size() during copy. It is safe to do so in GWT because javascript is
     * single-threaded.
     */
