...
public class ForwardingListTest extends TestCase {
    ...
    public void testForwarding() {
        new ForwardingWrapperTester().testForwarding(List.class, new Function<List, List>() {
            @Override
    ...
    public void testEquals() {
        ...
        new EqualsTester().addEqualityGroup(list1, wrap(list1), wrap(list1)).addEqualityGroup(list2, wrap(list2))
                .testEquals();
    }
