...
public class HashMultisetTest extends TestCase {
    ...
    public static Test suite() {
        ...
        suite.addTest(MultisetTestSuiteBuilder.using(hashMultisetGenerator())
                .withFeatures(CollectionSize.ANY, CollectionFeature.FAILS_FAST_ON_CONCURRENT_MODIFICATION,
                        ...
                        CollectionFeature.GENERAL_PURPOSE, MultisetFeature.ENTRIES_ARE_VIEWS)
                .named("HashMultiset").createTestSuite());
    ...
    /*
     * The behavior of toString() and iteration is tested by LinkedHashMultiset, which shares a lot
     * of code with HashMultiset and has deterministic iteration order.
     */
}
