...
public class SynchronizedNavigableMapTest extends SynchronizedMapTest {
    ...
    protected <K, V> NavigableMap<K, V> create() {
        ...
        NavigableMap<K, V> innermost = new SafeTreeMap<K, V>((Comparator<? super K>) Ordering.natural().nullsFirst());
    ...
    static class TestMap<K, V> extends SynchronizedMapTest.TestMap<K, V> implements NavigableMap<K, V> {
    ...
    public static TestSuite suite() {
        ...
        suite.addTest(NavigableMapTestSuiteBuilder.using(new TestStringSortedMapGenerator() {
            ...
            protected SortedMap<String, String> create(Entry<String, String>[] entries) {
                ...
                .withFeatures(CollectionSize.ANY, CollectionFeature.KNOWN_ORDER, MapFeature.GENERAL_PURPOSE,
