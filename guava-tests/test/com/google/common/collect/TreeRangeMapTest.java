...
public class TreeRangeMapTest extends TestCase {
    public static Test suite() {
        ...
        suite.addTest(MapTestSuiteBuilder.using(new TestMapGenerator<Range<Integer>, String>() {
            ...
            public SampleElements<Entry<Range<Integer>, String>> samples() {
                return new SampleElements<Entry<Range<Integer>, String>>(mapEntry(Range.singleton(0), "banana"),
                        mapEntry(Range.closedOpen(3, 5), "frisbee"), mapEntry(Range.atMost(-1), "fruitcake"),
                        mapEntry(Range.open(10, 15), "elephant"), mapEntry(Range.closed(20, 22), "umbrella"));
            }
            ...
            public String[] createValueArray(int length) {
                ...
                .withFeatures(CollectionSize.ANY, MapFeature.SUPPORTS_REMOVE, MapFeature.ALLOWS_ANY_NULL_QUERIES,
        ...
        }).named("TreeRangeMap.subRangeMap.asMapOfRanges").withFeatures(CollectionSize.ANY, MapFeature.SUPPORTS_REMOVE,
                MapFeature.ALLOWS_ANY_NULL_QUERIES, CollectionFeature.KNOWN_ORDER).createTestSuite());
        ...
        }).named("TreeRangeMap.subRangeMap.asDescendingMapOfRanges").withFeatures(CollectionSize.ANY,
                MapFeature.SUPPORTS_REMOVE, MapFeature.ALLOWS_ANY_NULL_QUERIES, CollectionFeature.KNOWN_ORDER)
                .createTestSuite());
        return suite;
    }
    ...
    public void testPutCoalescing() {
        ...
        assertEquals(ImmutableMap.of(Range.closedOpen(0, 2), 1, Range.closedOpen(2, 3), 2), rangeMap.asMapOfRanges());
    }
    ...
    public void testPutCoalescingEmpty() {
        ...
        assertEquals(ImmutableMap.of(Range.closedOpen(0, 1), 1, Range.closedOpen(1, 2), 1), rangeMap.asMapOfRanges());
    ...
    public void testPutCoalescingComplex() {
        ...
        assertEquals(new ImmutableMap.Builder<>().put(Range.closedOpen(-6, -4), 0).put(Range.closedOpen(0, 1), 1) // not
                                                                                                                  // coalesced
                .put(Range.closedOpen(1, 5), 1).put(Range.closedOpen(7, 9), 2).put(Range.closedOpen(9, 14), 0)
                .put(Range.closedOpen(14, 15), 2).put(Range.closedOpen(17, 20), 3).put(Range.closedOpen(22, 25), 4)
                .build(), rangeMap.asMapOfRanges());
    }
    ...
    public void testSubRangeMapPut() {
        ...
        assertEquals(ImmutableMap.of(Range.closedOpen(5, 7), 1, Range.closed(7, 9), 4, Range.openClosed(9, 10), 2),
                sub.asMapOfRanges());
        assertEquals(ImmutableMap.of(Range.open(3, 7), 1, Range.closed(7, 9), 4, Range.openClosed(9, 10), 2,
                Range.closed(12, 16), 3), rangeMap.asMapOfRanges());
    ...
    public void testSubRangeMapPutCoalescing() {
        ...
        assertEquals(ImmutableMap.of(Range.closedOpen(5, 7), 1, Range.closed(7, 10), 2), sub.asMapOfRanges());
        assertEquals(ImmutableMap.of(Range.open(3, 7), 1, Range.closed(7, 10), 2, Range.closed(12, 16), 3),
                rangeMap.asMapOfRanges());

        sub.putCoalescing(Range.singleton(7), 1);
        assertEquals(ImmutableMap.of(Range.closed(5, 7), 1, Range.openClosed(7, 10), 2), sub.asMapOfRanges());
        assertEquals(ImmutableMap.of(Range.open(3, 5), 1, Range.closed(5, 7), 1, Range.openClosed(7, 10), 2,
                Range.closed(12, 16), 3), rangeMap.asMapOfRanges());
    ...
    public void testSubRangeMapRemove() {
        ...
        assertEquals(ImmutableMap.of(Range.open(3, 7), 1, Range.openClosed(9, 10), 2, Range.closed(12, 16), 3),
                rangeMap.asMapOfRanges());

        sub.remove(Range.closed(3, 9));
        assertEquals(ImmutableMap.of(Range.openClosed(9, 10), 2), sub.asMapOfRanges());
        assertEquals(ImmutableMap.of(Range.open(3, 5), 1, Range.openClosed(9, 10), 2, Range.closed(12, 16), 3),
                rangeMap.asMapOfRanges());
    }
