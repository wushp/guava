...
public class ForwardingTableTest extends TestCase {
    ...
    public void testForwarding() {
        new ForwardingWrapperTester().testForwarding(Table.class, new Function<Table, Table>() {
            @Override
    ...
    public void testEquals() {
        ...
        new EqualsTester().addEqualityGroup(table1, wrap(table1), wrap(table1)).addEqualityGroup(table2, wrap(table2))
                .testEquals();
    }
