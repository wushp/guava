...
public abstract class AbstractTableReadTest extends TestCase {
     ...
     *
     * @param data the table data, repeating the sequence row key, column key, value once per
     *        mapping
    ...
    public void testEquals() {
        ...
        new EqualsTester().addEqualityGroup(table, hashCopy, reordered).addEqualityGroup(smaller)
    ...
    public void testHashCode() {
        table = create("foo", 1, 'a', "bar", 1, 'b', "foo", 3, 'c');
        int expected =
                Objects.hashCode("foo", 1, 'a') + Objects.hashCode("bar", 1, 'b') + Objects.hashCode("foo", 3, 'c');
