...
public class ForwardingMapTest extends TestCase {
        ...
        suite.addTest(MapTestSuiteBuilder.using(new TestStringMapGenerator() {
            ...
            protected Map<String, String> create(Entry<String, String>[] entries) {
                ...
                .withFeatures(CollectionSize.ANY, MapFeature.REJECTS_DUPLICATES_AT_CREATION,
                        MapFeature.ALLOWS_ANY_NULL_QUERIES, CollectionFeature.KNOWN_ORDER)
                .createTestSuite());
    ...
    public void testForwarding() {
        new ForwardingWrapperTester().testForwarding(Map.class, new Function<Map, Map>() {
            @Override
    ...
    public void testToStringWithNullKeys() throws Exception {
        ...
        StandardImplForwardingMap<String, String> forwardingMap =
                new StandardImplForwardingMap<String, String>(Maps.<String, String>newHashMap());
