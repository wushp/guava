...
public class ImmutableEnumMapTest extends TestCase {
    ...
    public static Test suite() {
        ...
        suite.addTest(MapTestSuiteBuilder.using(new ImmutableEnumMapGenerator()).named("Maps.immutableEnumMap")
    ...
    public void testImmutableEnumMapOrdering() {
        ...
        assertThat(map.entrySet()).containsExactly(Helpers.mapEntry(AnEnum.A, "a"), Helpers.mapEntry(AnEnum.C, "c"),
    ...
    public void testToImmutableEnumMap() {
        ...
        CollectorTester.of(collector, equivalence).expectCollects(
                ImmutableMap.of(AnEnum.A, 1, AnEnum.C, 2, AnEnum.E, 3), mapEntry(AnEnum.A, 1), mapEntry(AnEnum.C, 2),
                mapEntry(AnEnum.E, 3));
    }
    ...
    public void testToImmutableMapMerging() {
        ...
        Equivalence<ImmutableMap<AnEnum, Integer>> equivalence =
                Equivalence.equals().<Entry<AnEnum, Integer>>pairwise().onResultOf(ImmutableMap::entrySet);
        CollectorTester.of(collector, equivalence).expectCollects(
                ImmutableMap.of(AnEnum.A, 1, AnEnum.B, 4, AnEnum.C, 3), mapEntry(AnEnum.A, 1), mapEntry(AnEnum.B, 2),
                mapEntry(AnEnum.C, 3), mapEntry(AnEnum.B, 2));
    }
}
