    ...
    public static Test suite() {
        ...
        suite.addTest(MapTestSuiteBuilder.using(new TestClassToInstanceMapGenerator() {
            ...
            public Map<Class, Impl> create(Object... elements) {
                ...
                .withFeatures(MapFeature.GENERAL_PURPOSE, MapFeature.RESTRICTS_KEYS, MapFeature.ALLOWS_NULL_VALUES,
                        CollectionSize.ANY, CollectionFeature.SERIALIZABLE, CollectionFeature.SUPPORTS_ITERATOR_REMOVE,
