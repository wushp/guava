...
public class ForwardingMultisetTest extends TestCase {
    ...
    public static Test suite() {
        ...
        }).named("standardElementSet tripwire").withFeatures(CollectionSize.ANY, CollectionFeature.ALLOWS_NULL_VALUES,
    ...
    public void testForwarding() {
        new ForwardingWrapperTester().testForwarding(Multiset.class, new Function<Multiset, Multiset>() {
            @Override
