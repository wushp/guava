...
public class MapsCollectionTest extends TestCase {
    public static Test suite() {
        ...
        suite.addTest(NavigableMapTestSuiteBuilder.using(new TestStringSortedMapGenerator() {
            ...
            protected SortedMap<String, String> create(Entry<String, String>[] entries) {
                ...
                .withFeatures(CollectionSize.ANY, MapFeature.ALLOWS_NULL_VALUES, CollectionFeature.SERIALIZABLE)
                .createTestSuite());
        suite.addTest(BiMapTestSuiteBuilder.using(new TestStringBiMapGenerator() {
            ...
            protected BiMap<String, String> create(Entry<String, String>[] entries) {
                ...
                .withFeatures(CollectionSize.ANY, MapFeature.ALLOWS_NULL_VALUES, MapFeature.ALLOWS_NULL_KEYS,
                        MapFeature.ALLOWS_ANY_NULL_QUERIES, MapFeature.REJECTS_DUPLICATES_AT_CREATION,
                        CollectionFeature.SERIALIZABLE)
                .createTestSuite());
        suite.addTest(MapTestSuiteBuilder.using(new TestMapGenerator<String, Integer>() {
            @Override
            public SampleElements<Entry<String, Integer>> samples() {
                return new SampleElements<Entry<String, Integer>>(mapEntry("x", 1), mapEntry("xxx", 3),
                        mapEntry("xx", 2), mapEntry("xxxx", 4), mapEntry("aaaaa", 5));
            }
        ...
        }).named("Maps.asMap[Set, Function]").withFeatures(CollectionSize.ANY, MapFeature.SUPPORTS_REMOVE,
        ...
        suite.addTest(SortedMapTestSuiteBuilder.using(new TestMapGenerator<String, Integer>() {
            ...
            @Override
            public SampleElements<Entry<String, Integer>> samples() {
                return new SampleElements<Entry<String, Integer>>(mapEntry("a", 1), mapEntry("aa", 2),
                        mapEntry("aba", 3), mapEntry("bbbb", 4), mapEntry("ccccc", 5));
            }
        ...
        }).named("Maps.asMap[SortedSet, Function]").withFeatures(CollectionSize.ANY,
                CollectionFeature.SUPPORTS_ITERATOR_REMOVE, MapFeature.SUPPORTS_REMOVE).createTestSuite());
        ...
        }).named("Maps.asMap[NavigableSet, Function]").withFeatures(CollectionSize.ANY, MapFeature.SUPPORTS_REMOVE,
                CollectionFeature.SUPPORTS_ITERATOR_REMOVE).createTestSuite());
    ...
    static TestSuite filterBiMapSuite() {
        ...
        }).named("Maps.filterKeys[BiMap, Predicate]").withFeatures(MapFeature.ALLOWS_NULL_KEYS,
                MapFeature.ALLOWS_NULL_VALUES, MapFeature.GENERAL_PURPOSE, CollectionSize.ANY).createTestSuite());
        suite.addTest(BiMapTestSuiteBuilder.using(new TestStringBiMapGenerator() {
            @Override
            protected BiMap<String, String> create(Entry<String, String>[] entries) {
                BiMap<String, String> map = HashBiMap.create();
    ...
    static TestSuite filterSortedMapSuite() {
        ...
        suite.addTest(SortedMapTestSuiteBuilder.using(new TestStringSortedMapGenerator() {
            ...
            protected SortedMap<String, String> create(Entry<String, String>[] entries) {
                ...
                .withFeatures(MapFeature.ALLOWS_NULL_VALUES, MapFeature.GENERAL_PURPOSE, CollectionSize.ANY)
                .createTestSuite());
        suite.addTest(SortedMapTestSuiteBuilder.using(new TestStringSortedMapGenerator() {
            @Override
            protected SortedMap<String, String> create(Entry<String, String>[] entries) {
    ...
    private static class NonNavigableSortedMap extends ForwardingSortedMap<String, String> {
        ...
        private final SortedMap<String, String> delegate = new SafeTreeMap<String, String>(Ordering.natural());
    ...
    static TestSuite transformMapSuite() {
        ...
        suite.addTest(MapTestSuiteBuilder.using(new TestStringMapGenerator() {
            ...
            protected Map<String, String> create(Entry<String, String>[] entries) {
                ...
                .withFeatures(CollectionSize.ANY, CollectionFeature.KNOWN_ORDER, MapFeature.ALLOWS_NULL_KEYS,
                        MapFeature.ALLOWS_ANY_NULL_QUERIES, MapFeature.SUPPORTS_REMOVE,
    ...
    static TestSuite transformSortedMapSuite() {
        ...
        }).named("Maps.transformValues[SortedMap, Function]").withFeatures(CollectionSize.ANY,
                CollectionFeature.KNOWN_ORDER, MapFeature.SUPPORTS_REMOVE, CollectionFeature.SUPPORTS_ITERATOR_REMOVE)
                .createTestSuite());
        suite.addTest(SortedMapTestSuiteBuilder.using(new TestStringSortedMapGenerator() {
            @Override
            protected SortedMap<String, String> create(Entry<String, String>[] entries) {
        ...
        }).named("Maps.transformEntries[SortedMap, EntryTransformer]").withFeatures(CollectionSize.ANY,
                CollectionFeature.KNOWN_ORDER, MapFeature.SUPPORTS_REMOVE, CollectionFeature.SUPPORTS_ITERATOR_REMOVE)
                .createTestSuite());
        return suite;
    }
    ...
    static TestSuite transformNavigableMapSuite() {
        ...
        }).named("Maps.transformValues[NavigableMap, Function]").withFeatures(CollectionSize.ANY,
                CollectionFeature.KNOWN_ORDER, MapFeature.SUPPORTS_REMOVE, CollectionFeature.SUPPORTS_ITERATOR_REMOVE)
                .createTestSuite());
        suite.addTest(NavigableMapTestSuiteBuilder.using(new TestStringSortedMapGenerator() {
            @Override
        ...
        }).named("Maps.transformEntries[NavigableMap, EntryTransformer]").withFeatures(CollectionSize.ANY,
                CollectionFeature.KNOWN_ORDER, MapFeature.SUPPORTS_REMOVE, CollectionFeature.SUPPORTS_ITERATOR_REMOVE)
                .createTestSuite());
        return suite;
    }
