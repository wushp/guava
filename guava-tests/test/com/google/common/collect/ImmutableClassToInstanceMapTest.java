...
public class ImmutableClassToInstanceMapTest extends TestCase {
    ...
    public void testSerialization_empty() {
        assertSame(ImmutableClassToInstanceMap.of(), SerializableTester.reserialize(ImmutableClassToInstanceMap.of()));
    }
    ...
    public void testPrimitiveAndWrapper() {
        ImmutableClassToInstanceMap<Number> ictim =
                new ImmutableClassToInstanceMap.Builder<Number>().put(Integer.class, 0).put(int.class, 1).build();
    ...
    abstract static class TestClassToInstanceMapGenerator implements TestMapGenerator<Class, Impl> {
        ...
        public SampleElements<Entry<Class, Impl>> samples() {
            return new SampleElements<Entry<Class, Impl>>(immutableEntry((Class) One.class, new Impl(1)),
                    immutableEntry((Class) Two.class, new Impl(2)), immutableEntry((Class) Three.class, new Impl(3)),
                    immutableEntry((Class) Four.class, new Impl(4)), immutableEntry((Class) Five.class, new Impl(5)));
        }
