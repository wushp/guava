...
public class ForwardingNavigableMapTest extends TestCase {
    static class StandardImplForwardingNavigableMap<K, V> extends ForwardingNavigableMap<K, V> {
        ...
        public Set<K> keySet() {
            /*
             * We can't use StandardKeySet, as NavigableMapTestSuiteBuilder assumes that our keySet
             * is a NavigableSet. We test StandardKeySet in the superclass, so it's still covered.
             */
        ...
        /*
         * We can't override lastEntry to delegate to standardLastEntry, as it would create an
         * infinite loop. Instead, we test standardLastEntry manually below.
         */
    ...
    public static Test suite() {
        ...
        suite.addTest(NavigableMapTestSuiteBuilder.using(new TestStringSortedMapGenerator() {
            ...
            protected SortedMap<String, String> create(Entry<String, String>[] entries) {
        ...
        }).named("ForwardingNavigableMap[SafeTreeMap] with no comparator and standard " + "implementations")
                .withFeatures(CollectionSize.ANY, CollectionFeature.KNOWN_ORDER, MapFeature.ALLOWS_NULL_VALUES,
                 ...
                 *
                 * TODO(cpovirk): Consider making StandardDescendingMap return a ForwardingEntry
                 * that supports setValue().
                 */
                .suppressing(MapEntrySetTester.getSetValueMethod()).createTestSuite());
    ...
    public void testStandardLastEntry() {
        NavigableMap<String, Integer> forwarding =
                new StandardLastEntryForwardingNavigableMap<String, Integer>(new SafeTreeMap<String, Integer>());
    ...
    public void testForwarding() {
        new ForwardingWrapperTester().testForwarding(NavigableMap.class, new Function<NavigableMap, NavigableMap>() {
            @Override
    ...
    public void testEquals() {
        ...
        new EqualsTester().addEqualityGroup(map1, wrap(map1), wrap(map1)).addEqualityGroup(map2, wrap(map2))
                .testEquals();
    }
