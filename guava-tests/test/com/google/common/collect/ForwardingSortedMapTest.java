...
public class ForwardingSortedMapTest extends TestCase {
    ...
    public static Test suite() {
        ...
        }).named("ForwardingSortedMap[SafeTreeMap] with no comparator and standard " + "implementations")
        ...
        }).named("ForwardingSortedMap[SafeTreeMap] with natural comparator and " + "standard implementations")
                .withFeatures(CollectionSize.ANY, CollectionFeature.KNOWN_ORDER, MapFeature.ALLOWS_NULL_VALUES,
                        MapFeature.ALLOWS_NULL_KEYS, MapFeature.ALLOWS_ANY_NULL_QUERIES, MapFeature.GENERAL_PURPOSE,
    ...
    public void testForwarding() {
        new ForwardingWrapperTester().testForwarding(SortedMap.class, new Function<SortedMap, SortedMap>() {
            @Override
