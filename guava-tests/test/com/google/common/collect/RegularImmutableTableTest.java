...
public class RegularImmutableTableTest extends AbstractImmutableTableTest {
    private static final ImmutableSet<Cell<Character, Integer, String>> CELLS =
            ImmutableSet.of(Tables.immutableCell('a', 1, "foo"), Tables.immutableCell('b', 1, "bar"),
    ...
    private static final SparseImmutableTable<Character, Integer, String> SPARSE =
            new SparseImmutableTable<Character, Integer, String>(CELLS.asList(), ROW_SPACE, COLUMN_SPACE);

    private static final DenseImmutableTable<Character, Integer, String> DENSE =
            new DenseImmutableTable<Character, Integer, String>(CELLS.asList(), ROW_SPACE, COLUMN_SPACE);
    ...
    public void testForCells() {
        ...
        assertTrue(RegularImmutableTable
                .forCells(ImmutableSet.of(Tables.immutableCell('a', 1, "blah"), Tables.immutableCell('b', 2, "blah"),
                        Tables.immutableCell('c', 3, "blah"))) instanceof SparseImmutableTable<?, ?, ?>);
    }
    ...
    public void testColumnMap() {
        for (ImmutableTable<Character, Integer, String> testInstance : getTestInstances()) {
            assertEquals(ImmutableMap.of(1, ImmutableMap.of('a', "foo", 'b', "bar"), 2, ImmutableMap.of('a', "baz")),
    ...
    public void testRowMap() {
        for (ImmutableTable<Character, Integer, String> testInstance : getTestInstances()) {
            assertEquals(ImmutableMap.of('a', ImmutableMap.of(1, "foo", 2, "baz"), 'b', ImmutableMap.of(1, "bar")),
                    testInstance.rowMap());
        }
    }
}
