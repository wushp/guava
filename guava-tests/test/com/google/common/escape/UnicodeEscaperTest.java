...
public class UnicodeEscaperTest extends TestCase {
    ...
    private static final String SMALLEST_SURROGATE = "" + Character.MIN_HIGH_SURROGATE + Character.MIN_LOW_SURROGATE;
    private static final String LARGEST_SURROGATE = "" + Character.MAX_HIGH_SURROGATE + Character.MAX_LOW_SURROGATE;
    ...
    private static final UnicodeEscaper SIMPLE_ESCAPER = new UnicodeEscaper() {
        ...
        protected char[] escape(int cp) {
            return ('a' <= cp && cp <= 'z') || ('A' <= cp && cp <= 'Z') || ('0' <= cp && cp <= '9') ? null
    ...
    public void testSimpleEscaper() {
        ...
        String expected = "[0]abyz[128][256][2048][4096]ABYZ[65535]" + "[" + Character.MIN_SUPPLEMENTARY_CODE_POINT
    ...
    public void testBadStrings() {
        UnicodeEscaper e = SIMPLE_ESCAPER;
        String[] BAD_STRINGS = {String.valueOf(Character.MIN_LOW_SURROGATE), Character.MIN_LOW_SURROGATE + "xyz",
                "abc" + Character.MIN_LOW_SURROGATE, "abc" + Character.MIN_LOW_SURROGATE + "xyz",
                String.valueOf(Character.MAX_LOW_SURROGATE), Character.MAX_LOW_SURROGATE + "xyz",
                "abc" + Character.MAX_LOW_SURROGATE, "abc" + Character.MAX_LOW_SURROGATE + "xyz",};
