...
public class LinearTransformationTest extends TestCase {
    ...
    public void testMappingAnd_regular() {
        ...
        double xDelta = 5.6;
        double yDelta = 7.8;
        LinearTransformation transformation = LinearTransformation.mapping(x1, y1).and(x1 + xDelta, y1 + yDelta);
    ...
    public void testMappingWithSlope_vertical() {
        double x = 1.2;
        double y1 = 3.4;
        LinearTransformation transformation = LinearTransformation.mapping(x, y1).withSlope(Double.POSITIVE_INFINITY);
        assertVerticalLinearTransformation(transformation, x);
    }
    ...
    public void testMappingWithSlope_minimalSlope() {
        ...
        // Note that we cannot test the actual mapping of points, as the results will be unreliable
        // due
