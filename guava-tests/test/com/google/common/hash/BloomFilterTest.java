...
public class BloomFilterTest extends TestCase {
    ...
    public void testLargeBloomFilterDoesntOverflow() {
        ...
        assertTrue("BitArray.bitSize() must return a positive number, but was " + bitArray.bitSize(),
                bitArray.bitSize() > 0);

        // Ideally we would also test the bitSize() overflow of this BF, but it runs out of heap
        // space
    ...
    public void testCreateAndCheckMitz32BloomFilterWithKnownFalsePositives() {
        ...
        BloomFilter<String> bf = BloomFilter.create(Funnels.unencodedCharsFunnel(), numInsertions, 0.03,
        ...
        ImmutableSet<Integer> falsePositives =
                ImmutableSet.of(49, 51, 59, 163, 199, 321, 325, 363, 367, 469, 545, 561, 727, 769, 773, 781);
    ...
    public void testLargeNumberOfInsertions() {
        ...
        BloomFilter<String> unused = BloomFilter.create(Funnels.unencodedCharsFunnel(), Integer.MAX_VALUE / 2, 0.28);
    ...
    public void testEquals_empty() {
        new EqualsTester().addEqualityGroup(BloomFilter.create(Funnels.byteArrayFunnel(), 100, 0.01))
                ...
                .addEqualityGroup(BloomFilter.create(Funnels.unencodedCharsFunnel(), 200, 0.02)).testEquals();
    }
