...
public class DispatcherTest extends TestCase {
    ...
    private final ImmutableList<Subscriber> integerSubscribers = ImmutableList.of(
            subscriber(bus, i1, "handleInteger", Integer.class), subscriber(bus, i2, "handleInteger", Integer.class),
    ...
    private final ImmutableList<Subscriber> stringSubscribers = ImmutableList
            .of(subscriber(bus, s1, "handleString", String.class), subscriber(bus, s2, "handleString", String.class));
