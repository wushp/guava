...
public class ReentrantEventsTest extends TestCase {
    ...
    public void testNoReentrantEvents() {
        ...
        assertEquals("ReentrantEventHater expected 2 events", Lists.<Object>newArrayList(FIRST, SECOND),
    ...
    public void testEventOrderingIsPredictable() {
        ...
        assertEquals("EventRecorder expected events in order", Lists.<Object>newArrayList(FIRST, SECOND),
