...
public class CloserTest extends TestCase {
    ...
    public void testCloseExceptionsSuppressed_whenExceptionThrownFromTryBlock() throws IOException {
        ...
        assertSuppressed(new Suppression(c2, tryException, c2Exception),
    ...
    /**
     * Asserts that an exception was thrown when trying to close each of the given throwables and
     * that each such exception was suppressed because of the given thrown exception.
     */
