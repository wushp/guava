...
public class CharSequenceReaderTest extends TestCase {
    ...
    /**
     * Creates a CharSequenceReader wrapping the given CharSequence and tests that the reader
     * produces the same sequence when read using each type of read method it provides.
     */
