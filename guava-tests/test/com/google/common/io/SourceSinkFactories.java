...
public class SourceSinkFactories {
    ...
    public static CharSinkFactory asCharSinkFactory(final ByteSinkFactory factory) {
        ...
        return new CharSinkFactory() {
            ...
            public String getExpected(String data) {
                /*
                 * Get what the byte sink factory would expect for no written bytes, then append
                 * expected string to that.
                 */
    ...
    public static ByteSourceFactory asSlicedByteSourceFactory(final ByteSourceFactory factory, final long off,
            final long len) {
        checkNotNull(factory);
        return new ByteSourceFactory() {
            @Override
