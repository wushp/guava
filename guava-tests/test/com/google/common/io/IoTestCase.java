...
public abstract class IoTestCase extends TestCase {
    ...
    static final String I18N = "\u00CE\u00F1\u0163\u00E9\u0072\u00F1\u00E5\u0163\u00EE\u00F6"
            + "\u00F1\u00E5\u013C\u00EE\u017E\u00E5\u0163\u00EE\u00F6\u00F1";
    ...
    private File getTestDir() throws IOException {
        ...
        if (testDir == null) {
            // testdata resources aren't file:// urls, so create a directory to store them in and
            // then
    ...
    /**
     * Creates a new temp file in the temp directory returned by {@link #getTempDir()}. The file
     * will be deleted in the tear-down for this test.
     */
