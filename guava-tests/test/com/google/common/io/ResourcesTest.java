...
public class ResourcesTest extends IoTestCase {
    ...
    public static TestSuite suite() {
        ...
        suite.addTest(ByteSourceTester.tests("Resources.asByteSource[URL]", SourceSinkFactories.urlByteSourceFactory(),
                true));
    ...
    public void testGetResource_relativePath_notFound() {
        try {
            ...
            assertThat(e).hasMessage("resource com/google/common/io/testdata/i18n.txt"
