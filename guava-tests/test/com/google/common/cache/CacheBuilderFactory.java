...
class CacheBuilderFactory {
    ...
    Iterable<CacheBuilder<Object, Object>> buildAllPermutations() {
        ...
        Iterable<List<Object>> combinations = buildCartesianProduct(concurrencyLevels, initialCapacities, maximumSizes,
     ...
     * call the associated CacheBuilder method" - that is, get the default CacheBuilder behavior.
     * This method wraps the elements in the input sets (which may contain null) as Optionals, calls
