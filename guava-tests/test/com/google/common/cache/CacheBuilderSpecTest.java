...
public class CacheBuilderSpecTest extends TestCase {
    ...
    public void testParse_writeExpirationDays() {
        ...
        assertNull(spec.accessExpirationTimeUnit);
        assertCacheBuilderEquivalence(CacheBuilder.newBuilder().expireAfterWrite(10L, TimeUnit.DAYS),
    ...
    public void testParse_writeExpirationHours() {
        ...
        assertCacheBuilderEquivalence(CacheBuilder.newBuilder().expireAfterWrite(150L, TimeUnit.HOURS),
                CacheBuilder.from(spec));
    }
    ...
    public void testParse_writeExpirationMinutes() {
        ...
        assertEquals(10L, spec.writeExpirationDuration);
        assertCacheBuilderEquivalence(CacheBuilder.newBuilder().expireAfterWrite(10L, TimeUnit.MINUTES),
                CacheBuilder.from(spec));
    }
    ...
    public void testParse_writeExpirationSeconds() {
        ...
        assertEquals(10L, spec.writeExpirationDuration);
        assertCacheBuilderEquivalence(CacheBuilder.newBuilder().expireAfterWrite(10L, TimeUnit.SECONDS),
                CacheBuilder.from(spec));
    }
    ...
    public void testParse_accessExpirationDays() {
        ...
        assertCacheBuilderEquivalence(CacheBuilder.newBuilder().expireAfterAccess(10L, TimeUnit.DAYS),
                CacheBuilder.from(spec));
    }
    ...
    public void testParse_accessExpirationHours() {
        ...
        assertCacheBuilderEquivalence(CacheBuilder.newBuilder().expireAfterAccess(150L, TimeUnit.HOURS),
                CacheBuilder.from(spec));
    }
    ...
    public void testParse_accessExpirationMinutes() {
        ...
        assertEquals(10L, spec.accessExpirationDuration);
        assertCacheBuilderEquivalence(CacheBuilder.newBuilder().expireAfterAccess(10L, TimeUnit.MINUTES),
                CacheBuilder.from(spec));
    }
    ...
    public void testParse_accessExpirationSeconds() {
        ...
        assertEquals(10L, spec.accessExpirationDuration);
        assertCacheBuilderEquivalence(CacheBuilder.newBuilder().expireAfterAccess(10L, TimeUnit.SECONDS),
                CacheBuilder.from(spec));
    }
    ...
    public void testParse_accessExpirationAndWriteExpiration() {
        ...
        assertEquals(10L, spec.accessExpirationDuration);
        assertCacheBuilderEquivalence(CacheBuilder.newBuilder().expireAfterAccess(10L, TimeUnit.SECONDS)
                .expireAfterWrite(9L, TimeUnit.MINUTES), CacheBuilder.from(spec));
    }
    ...
    public void testParse_multipleKeys() {
        ...
        assertEquals(10L, spec.accessExpirationDuration);
        CacheBuilder<?, ?> expected = CacheBuilder.newBuilder().initialCapacity(10).maximumSize(20).concurrencyLevel(30)
                .weakKeys().weakValues().expireAfterAccess(10L, TimeUnit.MINUTES).expireAfterWrite(1L, TimeUnit.HOURS);
    ...
    public void testParse_whitespaceAllowed() {
        ...
        assertNull(spec.accessExpirationTimeUnit);
        CacheBuilder<?, ?> expected = CacheBuilder.newBuilder().initialCapacity(10).maximumSize(20).weakKeys()
                .softValues().expireAfterWrite(15L, TimeUnit.SECONDS);
        assertCacheBuilderEquivalence(expected, CacheBuilder.from(spec));
    }
    ...
    public void testEqualsAndHashCode() {
        new EqualsTester().addEqualityGroup(parse(""), parse(""))
                ...
                .addEqualityGroup(parse("recordStats"), parse("recordStats")).testEquals();
    }
    ...
    public void testCacheBuilderFrom_string() {
        CacheBuilder<?, ?> fromString = CacheBuilder.from(
                "initialCapacity=10,maximumSize=20,concurrencyLevel=30," + "weakKeys,weakValues,expireAfterAccess=10m");
        CacheBuilder<?, ?> expected = CacheBuilder.newBuilder().initialCapacity(10).maximumSize(20).concurrencyLevel(30)
                .weakKeys().weakValues().expireAfterAccess(10L, TimeUnit.MINUTES);
