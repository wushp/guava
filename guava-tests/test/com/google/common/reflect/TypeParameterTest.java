...
public class TypeParameterTest extends TestCase {
    ...
    public <T> void testCaptureTypeParameter() throws Exception {
        ...
        TypeVariable<?> expected =
                TypeParameterTest.class.getDeclaredMethod("testCaptureTypeParameter").getTypeParameters()[0];
    ...
    public <A, B> void testEquals() throws Exception {
        ...
        new EqualsTester().addEqualityGroup(new TypeParameter<A>() {}, new TypeParameter<A>() {})
                .addEqualityGroup(new TypeParameter<B>() {}).testEquals();
    }
