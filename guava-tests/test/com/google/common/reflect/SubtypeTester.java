 ...
 *
 * <p>
 * These declaration methods rely on Java static type checking to make sure what we want to assert
 * as subtypes are really subtypes according to javac. For example:
 * 
 * <pre>
 *    {@code
 *
 ...
 *
 * <p>
 * The declaration methods must be public.
 */
