...
public class TypeTokenTest extends TestCase {
    ...
    public void testGetTypes_withInterfacesAndSuperclasses() {
        ...
        makeUnmodifiable(types).containsExactly(new TypeToken<Class3<String>>() {},
                new TypeToken<Interface3<String>>() {}, new TypeToken<Iterable<String>>() {},
                TypeToken.of(Class2.class), TypeToken.of(Interface12.class), TypeToken.of(Interface1.class),
                TypeToken.of(Interface2.class), TypeToken.of(Class1.class), TypeToken.of(Object.class));
        makeUnmodifiable(types.interfaces()).containsExactly(new TypeToken<Interface3<String>>() {},
                TypeToken.of(Interface12.class), TypeToken.of(Interface1.class), TypeToken.of(Interface2.class),
    ...
    public void testGetTypes_rawTypes_withInterfacesAndSuperclasses() {
        ...
        TypeToken<Class3<String>>.TypeSet types = new TypeToken<Class3<String>>() {}.getTypes();
        makeUnmodifiable(types.rawTypes()).containsExactly(Class3.class, Interface3.class, Iterable.class, Class2.class,
                Interface12.class, Interface1.class, Interface2.class, Class1.class, Object.class);
        makeUnmodifiable(types.interfaces().rawTypes()).containsExactly(Interface3.class, Interface12.class,
                Interface1.class, Interface2.class, Iterable.class);
        makeUnmodifiable(types.classes().rawTypes()).containsExactly(Class3.class, Class2.class, Class1.class,
                Object.class);
        assertSubtypeFirst(types);
    }
    ...
    public <A extends Class1 & Interface1, B extends A> void testGetTypes_ignoresTypeVariablesByDefault() {
        ...
        makeUnmodifiable(types).containsExactly(TypeToken.of(Interface1.class), TypeToken.of(Class1.class),
                TypeToken.of(Object.class));
        assertSubtypeFirst(types);
        makeUnmodifiable(types.interfaces()).containsExactly(TypeToken.of(Interface1.class));
        makeUnmodifiable(types.classes()).containsExactly(TypeToken.of(Class1.class), TypeToken.of(Object.class))
                .inOrder();
    }
    ...
    public <A extends Interface1 & Interface2 & Interface3<String>> void testGetTypes_manyBounds() {
        ...
        makeUnmodifiable(types.rawTypes()).containsExactly(Interface1.class, Interface2.class, Interface3.class,
                Iterable.class);
    }
    ...
    public void testGetGenericSuperclass_withSuperclass() {
        TypeToken<? super ArrayList<String>> superToken = new TypeToken<ArrayList<String>>() {}.getGenericSuperclass();
    ...
    public void testGetGenericInterfaces_withInterfaces() {
        ...
        assertEquals(ImmutableMap.of(Iterable.class, new TypeToken<Iterable<String>>() {}.getType(), Map.class,
                new TypeToken<Map<Integer, String>>() {}.getType()), interfaceMap);
    }
    ...
    public <T> void testAssignableParameterizedTypeToObject() {
        assertTrue(TypeToken.of(Object.class).isSupertypeOf(TypeToken.of(new TypeCapture<T>() {}.capture())));
        assertFalse(TypeToken.of(int.class).isSupertypeOf(TypeToken.of(new TypeCapture<T>() {}.capture())));
    }
    ...
    public void testAssignableWithWildcards() {
        ...
        List<TypeToken<?>> allTokens = ImmutableList.of(unboundedToken, upperBoundToken, lowerBoundToken, concreteToken,
                subtypeToken, supertypeToken);
    ...
    public <N1 extends Number, N2 extends Number, N11 extends N1> void testisSupertypeOf_typeVariable() {
        ...
        assertNotAssignable(new TypeToken<Number>() {}, TypeToken.of(new TypeCapture<N1>() {}.capture()));
    ...
    public <N1 extends Number, N2 extends Number, N11 extends N1> void testisSupertypeOf_equalWildcardTypes() {
        assertAssignable(new TypeToken<List<? extends N1>>() {}, new TypeToken<List<? extends N1>>() {});
        assertAssignable(new TypeToken<List<? super N1>>() {}, new TypeToken<List<? super N1>>() {});
        assertAssignable(new TypeToken<List<? extends Number>>() {}, new TypeToken<List<? extends Number>>() {});
        assertAssignable(new TypeToken<List<? super Number>>() {}, new TypeToken<List<? super Number>>() {});
    }
    ...
    public <N1 extends Number, N2 extends Number, N11 extends N1> void testisSupertypeOf_wildcardType_upperBoundMatch() {
        ...
        assertAssignable(new TypeToken<List<? extends N11>>() {}, new TypeToken<List<? extends Number>>() {});
    }
    ...
    public <N1 extends Number, N2 extends Number, N11 extends N1> void testisSupertypeOf_wildcardType_lowerBoundMatch() {
        ...
        assertNotAssignable(new TypeToken<ArrayList<? super N11>>() {}, new TypeToken<List<? super Number>>() {});
        assertAssignable(new TypeToken<ArrayList<? super N1>>() {}, new TypeToken<List<? super N11>>() {});
        assertAssignable(new TypeToken<ArrayList<? super Number>>() {}, new TypeToken<List<? super N11>>() {});

        // ? super Number
        assertNotAssignable(new TypeToken<ArrayList<N11>>() {}, new TypeToken<List<? super Number>>() {});
        assertAssignable(new TypeToken<ArrayList<Number>>() {}, new TypeToken<List<? super Number>>() {});
        assertAssignable(new TypeToken<ArrayList<Object>>() {}, new TypeToken<List<? super Number>>() {});
    }
    ...
    public <T> void testGetComponentType_genericArrayClasses() {
        ...
        assertEquals(TypeToken.of(new TypeCapture<T>() {}.capture()), new TypeToken<T[]>() {}.getComponentType());
    ...
    public void testGetComponentType_wildcardType() {
        ...
        assertEquals(Types.subtypeOf(Object[].class),
                Types.newArrayType(TypeToken.of(Types.subtypeOf(Object[].class)).getComponentType().getType()));
    ...
    public void testImplicitUpperBoundForWildcards() {
        assertAssignable(new TypeToken<NumberList<? extends Number>>() {}, new TypeToken<NumberList<?>>() {});
        assertAssignable(new TypeToken<NumberList<? super Integer>>() {}, new TypeToken<NumberList<?>>() {});
    }
    ...
    public <A, T extends Number & Iterable<A>> void testGetSupertype_typeVariableWithMultipleBounds() {
        assertEquals(Number.class, new TypeToken<T>(getClass()) {}.getSupertype(Number.class).getType());
        assertEquals(new TypeToken<Iterable<A>>() {}, new TypeToken<T>(getClass()) {}.getSupertype(Iterable.class));
    }

    public void testGetSupertype_withoutTypeVariable() {
        ParameterizedType expectedType =
                Types.newParameterizedType(Iterable.class, Types.newParameterizedType(List.class, String.class));
        assertEquals(expectedType, TypeToken.of(StringListIterable.class).getSupertype(Iterable.class).getType());
    }

    public void testGetSupertype_chained() {
        @SuppressWarnings("unchecked") // StringListIterable extensd ListIterable<String>
        TypeToken<ListIterable<String>> listIterableType = (TypeToken<ListIterable<String>>) TypeToken
                .of(StringListIterable.class).getSupertype(ListIterable.class);
        ParameterizedType expectedType =
                Types.newParameterizedType(Iterable.class, Types.newParameterizedType(List.class, String.class));
    ...
    public void testGetSupertype_fromWildcard() {
        ...
        TypeToken<? extends List<String>> type = (TypeToken<? extends List<String>>) TypeToken
                .of(Types.subtypeOf(new TypeToken<List<String>>() {}.getType()));
    ...
    public <T extends Iterable<String>> void testGetSupertype_fromTypeVariable() {
        ...
        assertEquals(new TypeToken<Iterable<String>>() {}, typeVariableToken.getSupertype(Iterable.class));
    }
    ...
    public void testGetSupertype_fullyGenericType() {
        ParameterizedType expectedType = Types.newParameterizedType(Map.class, ListMap.class.getTypeParameters()[0],
    ...
    public void testGetSupertype_fullySpecializedType() {
        ...
        assertEquals(expectedType, new TypeToken<ListMap<String, Object>>() {}.getSupertype(Map.class).getType());
    }
    ...
    public <V> void testGetSupertype_partiallySpecializedType() {
        ...
        assertEquals(expectedType, new TypeToken<StringListMap<V>>() {}.getSupertype(Map.class).getType());
    }
    ...
    public void testGetSubtype_fromWildcard() {
        @SuppressWarnings("unchecked") // can't do new TypeToken<? extends ...>() {}
        TypeToken<? super Iterable<String>> type = (TypeToken<? super Iterable<String>>) TypeToken
                .of(Types.supertypeOf(new TypeToken<Iterable<String>>() {}.getType()));
    ...
    public void testGetSubtype_fromWildcard_lowerBoundNotSupertype() {
        @SuppressWarnings("unchecked") // can't do new TypeToken<? extends ...>() {}
        TypeToken<? super Iterable<String>> type = (TypeToken<? super Iterable<String>>) TypeToken
                .of(Types.supertypeOf(new TypeToken<ImmutableList<String>>() {}.getType()));
        try {
    ...
    public void testGetSubtype_fromWildcard_upperBounded() {
        @SuppressWarnings("unchecked") // can't do new TypeToken<? extends ...>() {}
        TypeToken<? extends Iterable<String>> type = (TypeToken<? extends Iterable<String>>) TypeToken
                .of(Types.subtypeOf(new TypeToken<Iterable<String>>() {}.getType()));
        try {
    ...
    public void testGetSubtype_toWildcard() {
        ...
        assertEquals(new TypeToken<StringForFirstTypeArg<?>>() {}, supertype.getSubtype(subtype.getRawType()));
    }
    ...
    public void testGetSubtype_toWildcardWithBounds() {
        ...
        // TODO(benyu): This should check equality to an expected value, see discussion in
        // cl/98674873
    ...
    public <T> void testGetSubtype_manyGenericArgs() {
        ...
        assertTrue(subtype.isSubtypeOf(supertype));
        assertEquals(new TypeToken<ThreeTypeArgs<T, Integer, ?>>() {}, supertype.getSubtype(subtype.getRawType()));
    }
    ...
    public void testGetSubtype_recursiveTypeBoundInSubtypeTranslatedAsIs() {
        ...
        ParameterizedType subtype =
                (ParameterizedType) new TypeToken<BaseWithTypeVar<List<?>>>() {}.getSubtype(Outer.Sub.class).getType();
    ...
    public <T> void testWhere_circleRejected() {
        ...
        try {
            type.where(new TypeParameter<T>() {}, (TypeToken<T>) TypeToken.of(new TypeCapture<T>() {}.capture()));
            fail();
        } catch (IllegalArgumentException expected) {
        }
    }
    ...
    public void testWildcardCaptured_methodParameter_upperBound() throws Exception {
        ...
        TypeToken<?> parameterType =
                type.resolveType(Holder.class.getDeclaredMethod("setList", List.class).getGenericParameterTypes()[0]);
    ...
    public <T extends Number & List<String>> void testMethod_returnType_resolvedAgainstTypeBound()
        ...
        Invokable<T, String> invokable = new TypeToken<T>(getClass()) {}.method(getMethod).returning(String.class);
    ...
    public void testMethod_equals() throws NoSuchMethodException {
        Method getMethod = List.class.getMethod("get", int.class);
        Method setMethod = List.class.getMethod("set", int.class, Object.class);
        new EqualsTester().addEqualityGroup(Invokable.from(getMethod), Invokable.from(getMethod))
                ...
                .addEqualityGroup(new TypeToken<List<String>>() {}.method(setMethod)).testEquals();
    }
    ...
    public void testConstructor_equals() throws NoSuchMethodException {
        ...
        new EqualsTester().addEqualityGroup(Invokable.from(defaultConstructor), Invokable.from(defaultConstructor))
                ...
                .addEqualityGroup(new TypeToken<ArrayList<String>>() {}.constructor(oneArgConstructor)).testEquals();
    }
    ...
    public void testTypeResolution() {
        ...
        assertEquals(new TypeToken<Map<String, Integer>>() {}, new IKnowMyType<Map<String, Integer>>() {}.type());
    }
    ...
    public void testTypeResolutionAfterReserialized() {
        ...
        reserialize(new TypeToken<Map<String, Integer>>() {});
        TypeToken<Map<String, Integer>> reserialized = reserialize(new TypeToken<Map<String, Integer>>() {});
    ...
    public void testDespiteGenericSignatureFormatError() {
        ImmutableSet<?> unused = ImmutableSet.copyOf(
                TypeToken.of(ToReproduceGenericSignatureFormatError.SubOuter.SubInner.class).getTypes().rawTypes());
    }
    ...
    public <A, B> void testEquals() {
        new EqualsTester()
                .addEqualityGroup(TypeToken.of(String.class), TypeToken.of(String.class),
                        new Entry<String, Integer>() {}.keyType(), new Entry<Integer, String>() {}.valueType(),
                        new TypeToken<String>() {}, new TypeToken<String>() {})
                .addEqualityGroup(TypeToken.of(Integer.class), new TypeToken<Integer>() {},
                        new Entry<Integer, String>() {}.keyType(), new Entry<String, Integer>() {}.valueType())
                ...
                .addEqualityGroup(TypeToken.of(new TypeCapture<A>() {}.capture()),
                        TypeToken.of(new TypeCapture<A>() {}.capture()))
                .addEqualityGroup(TypeToken.of(new TypeCapture<B>() {}.capture())).testEquals();
    }
    ...
    private static void assertAssignable(TypeToken<?> from, TypeToken<?> to) {
        assertTrue(from.getType() + " is expected to be assignable to " + to.getType(), to.isSupertypeOf(from));
        assertTrue(to.getType() + " is expected to be a supertype of " + from.getType(), to.isSupertypeOf(from));
    ...
    private static void assertNotAssignable(TypeToken<?> from, TypeToken<?> to) {
        assertFalse(from.getType() + " shouldn't be assignable to " + to.getType(), to.isSupertypeOf(from));
