...
public class TypeResolverTest extends TestCase {
    ...
    public <T> void testWhere_rawClassSelfMapping() {
        TypeResolver resolver = new TypeResolver();
        assertEquals(String.class, resolver.where(String.class, String.class).resolveType(String.class));
    }
    ...
    public <T> void testWhere_genericArrayMapping() {
        ...
        assertEquals(String.class,
                new TypeResolver().where(new TypeCapture<T[]>() {}.capture(), String[].class).resolveType(t));
    }
    ...
    public <T> void testWhere_parameterizedTypeMapping() {
        ...
        assertEquals(String.class,
                new TypeResolver()
                        .where(new TypeCapture<List<T>>() {}.capture(), new TypeCapture<List<String>>() {}.capture())
                        .resolveType(t));
        assertEquals(Types.subtypeOf(String.class), new TypeResolver()
                .where(new TypeCapture<List<T>>() {}.capture(), new TypeCapture<List<? extends String>>() {}.capture())
                .resolveType(t));
        assertEquals(Types.supertypeOf(String.class), new TypeResolver()
                .where(new TypeCapture<List<T>>() {}.capture(), new TypeCapture<List<? super String>>() {}.capture())
                .resolveType(t));
    }

    public <T> void testWhere_wildcardTypeMapping() {
        Type t = new TypeCapture<T>() {}.capture();
        assertEquals(String.class, new TypeResolver().where(new TypeCapture<List<? extends T>>() {}.capture(),
                new TypeCapture<List<? extends String>>() {}.capture()).resolveType(t));
        assertEquals(String.class, new TypeResolver().where(new TypeCapture<List<? super T>>() {}.capture(),
                new TypeCapture<List<? super String>>() {}.capture()).resolveType(t));
    }
    ...
    public <T> void testWhere_impossibleParameterizedTypeMapping() {
        try {
            new TypeResolver().where(new TypeCapture<List<T>>() {}.capture(),
    ...
    public <T> void testWhere_incompatibleWildcardUpperBound() {
        try {
            new TypeResolver().where(new TypeCapture<List<? extends String>>() {}.capture(),
    ...
    public <T> void testWhere_incompatibleWildcardLowerBound() {
        try {
            new TypeResolver().where(new TypeCapture<List<? super String>>() {}.capture(),
    ...
    public <T> void testWhere_incompatibleWildcardBounds() {
        try {
            new TypeResolver().where(new TypeCapture<List<? extends T>>() {}.capture(),
    ...
    public <K, V> void testWhere_actualArgHasWildcard() {
        TypeResolver resolver = new TypeResolver().where(new TypeCapture<Iterable<Map<?, V>>>() {}.capture(),
                new TypeCapture<Iterable<Map<String, Integer>>>() {}.capture());
        assertEquals(new TypeCapture<K>() {}.capture(), resolver.resolveType(new TypeCapture<K>() {}.capture()));
    ...
    public <T> void testWhere_mapFromWildcard() {
        ...
        assertEquals(new TypeCapture<TypedKeyMap<String>>() {}.capture(), new TypeResolver()
                .where(new TypeCapture<Map<Integer, T>>() {}.capture(), new TypeCapture<Map<?, String>>() {}.capture())
                .resolveType(subtype));
    }
    ...
    public <T> void testWhere_mapFromWildcardToParameterized() {
        ...
        assertEquals(new TypeCapture<TypedListKeyMap<String>>() {}.capture(),
                new TypeResolver().where(new TypeCapture<Map<List<Integer>, T>>() {}.capture(),
                        new TypeCapture<Map<?, String>>() {}.capture()).resolveType(subtype));
    }
    ...
    public <T> void testWhere_mapFromBoundedWildcard() {
        ...
        Type unused =
                new TypeResolver()
                        .where(new TypeCapture<Map<Integer, T>>() {}.capture(),
