...
public class AbstractInvocationHandlerTest extends TestCase {
    ...
    public void testEquals() {
        ...
        AB ab = new AB();
        BA ba = new BA();
        new EqualsTester().addEqualityGroup(newDelegatingList(LIST1))
                // Actually, this violates List#equals contract.
                // But whatever, no one is going to proxy List (hopefully).
                .addEqualityGroup(newDelegatingList(LIST1)).addEqualityGroup(newDelegatingList(LIST2))
                .addEqualityGroup(newProxyWithEqualsForInterfaces(List.class, Runnable.class),
                ...
                .addEqualityGroup(newDelegatingListWithEquals(LIST2), newProxyWithSubHandler1(LIST2), // Makes
                                                                                                      // sure
                                                                                                      // type
                                                                                                      // of
                                                                                                      // handler
    ...
    private static Object newProxyWithEqualsForInterfaces(Class<?>... interfaces) {
        return Proxy.newProxyInstance(AbstractInvocationHandlerTest.class.getClassLoader(), interfaces,
                new DelegatingInvocationHandlerWithEquals("a string"));
    }

    private static class DelegatingInvocationHandler extends AbstractInvocationHandler implements Serializable {
