...
public class TypeTokenResolutionTest extends TestCase {
    ...
    public void testInnerClassWithParameterizedOwner() throws Exception {
        ...
        assertEquals(fieldType, TypeToken.of(ParameterizedOuter.class).resolveType(fieldType).getType());
    }
    ...
    public void testResolveType() {
        ...
        assertEquals(String.class,
                TypeToken.of(StringIterable.class).resolveType(Iterable.class.getTypeParameters()[0]).getType());
        assertEquals(String.class,
                TypeToken.of(StringIterable.class).resolveType(Iterable.class.getTypeParameters()[0]).getType());
        try {
    ...
    private abstract class WithGenericBound<A> {
        ...
        Type getTargetType(String methodName) throws Exception {
            ParameterizedType parameterType = (ParameterizedType) WithGenericBound.class
    ...
    public void testWithMutualRecursiveBoundInTypeVariable() throws Exception {
        ParameterizedType paramType =
                (ParameterizedType) new WithGenericBound<String>() {}.getTargetType("withMutualRecursiveBound");
    ...
    public void testInterfaceTypeParameterResolution() throws Exception {
        assertEquals(String.class, TypeToken.of(new TypeToken<ArrayList<String>>() {}.getType())
