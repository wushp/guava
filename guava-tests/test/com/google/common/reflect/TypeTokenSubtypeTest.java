...
public class TypeTokenSubtypeTest extends TestCase {
    ...
    public static void testSubtypeOfStaticAnonymousClass() {
        ...
        assertFalse(TypeToken.of(new Mall<Outdoor>().new Shop<Electronics>() {}.getClass()).isSubtypeOf(superclass));
    }
    ...
    private static class OwnerTypeSubtypingTests extends SubtypeTester {
        ...
        @TestSubtype
        public Mall<Outdoor>.Shop<Electronics> ownerTypeIsSubtype(Outlet<Outdoor>.Shop<Electronics> shop) {
        ...
        @TestSubtype(suppressGetSupertype = true, suppressGetSubtype = true)
        public Mall<? super Outdoor>.Shop<? extends Electronics> bothOwnerTypeAndInnerTypeAreSubtypes_supertypeWithWildcard(
                Outlet<Outdoor>.Retailer<Electronics> retailer) {
            return isSubtype(retailer);
        }

        @TestSubtype(suppressGetSupertype = true, suppressGetSubtype = true)
        public Mall<? super Outdoor>.Shop<? extends Electronics> bothOwnerTypeAndInnerTypeAreSubtypes_withWildcards(
                Outlet<Outdoor>.Retailer<Electronics> retailer) {
            return isSubtype(retailer);
        }
        ...
        public ConsumerFacing<Electronics> supertypeIsNestedClass(Mall<Indoor>.Retailer<Electronics> shop) {
            return isSubtype(shop);
        }
        ...
        @TestSubtype(suppressGetSubtype = true)
        public Comparator<Electronics> supertypeIsTopLevelClass(Mall<Indoor>.Retailer<Electronics> shop) {
            return isSubtype(shop);
        }
    ...
    // TODO(benyu): migrate all subtyping tests from TypeTokenTest to this class using
    // SubtypeTester.
