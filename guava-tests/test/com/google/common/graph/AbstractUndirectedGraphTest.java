 ...
 *
 * <p>
 * This class is responsible for testing that an undirected implementation of {@link Graph} is
...
public abstract class AbstractUndirectedGraphTest extends AbstractGraphTest {
    ...
    public void validateUndirectedEdges() {
        for (Integer node : graph.nodes()) {
            new EqualsTester()
                    .addEqualityGroup(graph.predecessors(node), graph.successors(node), graph.adjacentNodes(node))
                    .testEquals();
        }
    }
