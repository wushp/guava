    ...
    private static void testNetworkMutation(NetworkBuilder<? super Integer, Object> networkBuilder) {
        ...
        for (int trial = 0; trial < NUM_TRIALS; ++trial) {
            ...
            for (int i = 0; i < NUM_EDGES; ++i) {
                ...
                assertThat(
                        network.addEdge(getRandomElement(nodeList, gen), getRandomElement(nodeList, gen), new Object()))
                                .isTrue();
            }
            ...
            for (Object edge : edgeList) {
                assertThat(network.addEdge(getRandomElement(nodeList, gen), getRandomElement(nodeList, gen), edge))
                        .isTrue();
            }
