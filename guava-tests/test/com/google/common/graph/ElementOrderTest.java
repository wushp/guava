...
public final class ElementOrderTest {
    ...
    public void nodeOrder_sorted() {
        MutableGraph<Integer> graph =
                GraphBuilder.directed().nodeOrder(ElementOrder.sorted(Ordering.<Integer>natural().reverse())).build();
    ...
    public void edgeOrder_none() {
        MutableNetwork<Integer, String> network = NetworkBuilder.directed().edgeOrder(unordered()).build();
    ...
    public void edgeOrder_sorted() {
        MutableNetwork<Integer, String> network =
                NetworkBuilder.directed().edgeOrder(ElementOrder.sorted(Ordering.<String>natural().reverse())).build();
    ...
    public void nodeOrderUnorderedandEdgesSorted() {
        MutableNetwork<Integer, String> network = NetworkBuilder.directed().nodeOrder(unordered())
                .edgeOrder(ElementOrder.sorted(Ordering.<String>natural().reverse())).build();
