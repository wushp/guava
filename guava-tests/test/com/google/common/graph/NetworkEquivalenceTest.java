...
public final class NetworkEquivalenceTest {
    ...
    // (In this case the networks are considered equivalent; the property differences are
    // irrelevant.)
    @Test
    public void equivalent_propertiesDiffer() {
        ...
        MutableNetwork<Integer, String> g2 =
                NetworkBuilder.from(network).allowsParallelEdges(!network.allowsParallelEdges())
                        .allowsSelfLoops(!network.allowsSelfLoops()).build();
        g2.addEdge(N1, N2, E12);
