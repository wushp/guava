...
public final class MapCacheTest {
    ...
    public static Collection<Object[]> parameters() {
        ...
        return Arrays.asList(new Object[][] {{new MapIteratorCache<String, String>(new HashMap<String, String>())},
    ...
    public void testRemoveEqualKeyWithDifferentReference() {
        ...
        assertThat(mapCache.get(fooReference1)).isEqualTo("bar"); // ensure first reference is
                                                                  // cached
