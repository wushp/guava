...
public class FunctionsTest extends TestCase {
    ...
    public void testForMapWithoutDefault() {
        ...
        new EqualsTester().addEqualityGroup(function, Functions.forMap(map)).addEqualityGroup(Functions.forMap(map, 42))
                .testEquals();
    }
    ...
    public void testForMapWithDefault() {
        ...
        new EqualsTester().addEqualityGroup(function, Functions.forMap(map, 42)).addEqualityGroup(Functions.forMap(map))
                .addEqualityGroup(Functions.forMap(map, null)).addEqualityGroup(Functions.forMap(map, 43)).testEquals();
    }
    ...
    public void testForMapWithDefault_includeSerializable() {
        ...
        new EqualsTester()
                .addEqualityGroup(function, Functions.forMap(map, 42), SerializableTester.reserialize(function))
                .addEqualityGroup(Functions.forMap(map)).addEqualityGroup(Functions.forMap(map, null))
    ...
    public void testForMapWithDefault_null() {
        ...
        new EqualsTester().addEqualityGroup(function).addEqualityGroup(Functions.forMap(map, 1)).testEquals();
    }
    ...
    public void testForMapWithDefault_null_compareWithSerializable() {
        ...
        // check basic sanity of equals and hashCode
        new EqualsTester().addEqualityGroup(function, SerializableTester.reserialize(function))
                .addEqualityGroup(Functions.forMap(map, 1)).testEquals();
    }
    ...
    public void testComposition() {
        ...
        new EqualsTester().addEqualityGroup(japaneseToSpanish, Functions.compose(integerToSpanish, japaneseToInteger))
                .addEqualityGroup(japaneseToInteger).addEqualityGroup(integerToSpanish)
                .addEqualityGroup(Functions.compose(japaneseToInteger, integerToSpanish)).testEquals();
    }
    ...
    public void testForPredicate() {
        ...
        new EqualsTester().addEqualityGroup(alwaysTrue, Functions.forPredicate(Predicates.alwaysTrue()))
                .addEqualityGroup(alwaysFalse).addEqualityGroup(Functions.identity()).testEquals();
    }
    ...
    public void testConstant() {
        ...
        new EqualsTester().addEqualityGroup(f, Functions.constant("correct"))
                .addEqualityGroup(Functions.constant("incorrect")).addEqualityGroup(Functions.toStringFunction())
                .addEqualityGroup(g).testEquals();

        new EqualsTester().addEqualityGroup(g, Functions.constant(null))
                .addEqualityGroup(Functions.constant("incorrect")).addEqualityGroup(Functions.toStringFunction())
                .addEqualityGroup(f).testEquals();
    }
    ...
    public void testForSupplier() {
        ...
        new EqualsTester().addEqualityGroup(function, Functions.forSupplier(supplier))
                ...
                .addEqualityGroup(Functions.toStringFunction()).testEquals();
    }
