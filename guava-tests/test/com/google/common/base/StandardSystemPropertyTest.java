...
public class StandardSystemPropertyTest extends TestCase {
    ...
    public void testNoNullValues() {
        for (StandardSystemProperty property : StandardSystemProperty.values()) {
            // Even though the contract in System.getProperties() specifies that a value will exist
            // for
            // all of the listed keys, for some reason the "java.compiler" key returns null in some
            // JVMs.
