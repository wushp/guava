...
public class AsciiTest extends TestCase {
    ...
    public void testEqualsIgnoreCaseUnicodeEquivalence() {
        ...
        // equalsIgnoreCase()
        // may change and break assumptions in this test [*]. This is not a bug in the
        // implementation of
        // Ascii.equalsIgnoreCase(), but it is a signal that its documentation may need updating as
        // regards edge cases.

        // The Unicode point {@code 00df} is the lowercase form of sharp-S (ß), whose uppercase is
        // "SS".
