...
public class UnsignedLongsTest extends TestCase {
    ...
    public void testMax() {
        ...
        assertEquals(0xff1a618b7f65ea12L,
                UnsignedLongs.max(0x5a4316b8c153ac4dL, 8L, 100L, 0L, 0x6cf78a4b139a4e2aL, 0xff1a618b7f65ea12L));
    }
    ...
    public void testMin() {
        ...
        assertEquals(0L,
                UnsignedLongs.min(0x5a4316b8c153ac4dL, 8L, 100L, 0L, 0x6cf78a4b139a4e2aL, 0xff1a618b7f65ea12L));
    }

    public void testLexicographicalComparator() {
        List<long[]> ordered = Arrays.asList(new long[] {}, new long[] {LEAST}, new long[] {LEAST, LEAST},
                new long[] {LEAST, (long) 1}, new long[] {(long) 1}, new long[] {(long) 1, LEAST},
                new long[] {GREATEST, GREATEST - (long) 1}, new long[] {GREATEST, GREATEST},
    ...
    public void testRemainder() {
        ...
        assertEquals(0xfffffffffffffffdL, UnsignedLongs.remainder(0xfffffffffffffffdL, 0xfffffffffffffffeL));
    ...
    public void testToString() {
        String[] tests =
                {"ffffffffffffffff", "7fffffffffffffff", "ff1a618b7f65ea12", "5a4316b8c153ac4d", "6cf78a4b139a4e2a"};
