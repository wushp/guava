...
public class SignedBytesTest extends TestCase {
    ...
    public void testMax() {
        ...
        assertEquals((byte) 127, SignedBytes.max((byte) 0, (byte) -128, (byte) -1, (byte) 127, (byte) 1));
    }
    ...
    public void testMin() {
        ...
        assertEquals((byte) -128, SignedBytes.min((byte) 0, (byte) -128, (byte) -1, (byte) 127, (byte) 1));
    }
