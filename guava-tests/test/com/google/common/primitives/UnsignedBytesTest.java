...
public class UnsignedBytesTest extends TestCase {
    ...
    public void testMax() {
        ...
        assertEquals((byte) 255, UnsignedBytes.max((byte) 0, (byte) -128, (byte) -1, (byte) 127, (byte) 1));
    }
    ...
    public void testMin() {
        ...
        assertEquals((byte) 0, UnsignedBytes.min((byte) 0, (byte) -128, (byte) -1, (byte) 127, (byte) 1));
        assertEquals((byte) 0, UnsignedBytes.min((byte) -1, (byte) 127, (byte) 1, (byte) -128, (byte) 0));
    }
    ...
    public void testLexicographicalComparatorDefaultChoice() {
        ...
        Comparator<byte[]> unsafeComparator = UnsignedBytes.LexicographicalComparatorHolder.UnsafeComparator.INSTANCE;
        assertSame(defaultComparator, unsafeComparator);
    }

    public void testLexicographicalComparator() {
        List<byte[]> ordered = Arrays.asList(new byte[] {}, new byte[] {LEAST}, new byte[] {LEAST, LEAST},
                new byte[] {LEAST, (byte) 1}, new byte[] {(byte) 1}, new byte[] {(byte) 1, LEAST},
                new byte[] {GREATEST, GREATEST - (byte) 1}, new byte[] {GREATEST, GREATEST},
