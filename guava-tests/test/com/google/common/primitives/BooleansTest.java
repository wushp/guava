...
public class BooleansTest extends TestCase {
    ...
    public void testEnsureCapacity() {
        ...
        assertTrue(
                Arrays.equals(new boolean[] {true, false, false}, Booleans.ensureCapacity(new boolean[] {true}, 2, 1)));
    }
    ...
    public void testLexicographicalComparator() {
        List<boolean[]> ordered = Arrays.asList(new boolean[] {}, new boolean[] {false}, new boolean[] {false, false},
