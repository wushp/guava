...
public class UrlEscapersTest extends TestCase {
    ...
    public void testUrlFormParameterEscaper() {
        ...
        /*
         * Specified as safe by RFC 2396 but not by java.net.URLEncoder. These tests will start
         * failing when the escaper is made compliant with RFC 2396, but that's a good thing (just
         * change them to assertUnescaped).
         */
        assertEscaping(e, "%21", '!');
        assertEscaping(e, "%28", '(');
        assertEscaping(e, "%29", ')');
