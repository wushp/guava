 ...
 * {@link java.util.concurrent.locks.ReentrantLock#hasWaiters(java.util.concurrent.locks.Condition)},
...
public final class TestThread<L> extends Thread implements TearDown {
    ...
    // so there is no object state put at risk by stopping the threads abruptly. In some cases a
    // test
     ...
     * type of throwable.
     */
    public void callAndAssertThrows(Class<? extends Throwable> expected, String methodName, Object... arguments)
            throws Exception {
     ...
     * the lock-like object. The lock-like object must have a method equivalent to
     * {@link java.util.concurrent.locks.ReentrantLock#hasQueuedThread(Thread)}.
     */
     ...
     * the given condition-like object. The lock-like object must have a method equivalent to
     * {@link java.util.concurrent.locks.ReentrantLock#hasWaiters(java.util.concurrent.locks.Condition)},
     * except that the method parameter must accept whatever condition-like object is passed into
     * this method.
     */
     ...
     *
     * @throws TimeoutException if this thread does not accept the request within a reasonable
     *         amount of time
     */
     ...
     *
     * @throws TimeoutException if this thread does not offer a response within a reasonable amount
     *         of time
    ...
    public void run() {
        ...
        try {
            ...
            // SynchronousQueue sometimes throws InterruptedException while the threads are
            // stopping.
