 ...
 * http://gee.cs.oswego.edu/cgi-bin/viewcvs.cgi/jsr166/src/test/tck/AbstractExecutorServiceTest.java
 * ?revision=1.30 which contained the following notice:
 *
...
public class MoreExecutorsTest extends JSR166TestCase {
    ...
    public void testListeningDecorator_scheduleSuccess() throws Exception {
         ...
         * ListeningScheduledExecutorService's wrapper task is done executing listeners, as detected
         * by yielding control to afterExecute.
         */
        completed.await();
        assertTrue(future.isDone());
