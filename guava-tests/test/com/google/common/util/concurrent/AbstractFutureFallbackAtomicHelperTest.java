 ...
 *
 * <p>
 * On different platforms AbstractFuture uses different strategies for its core synchronization
...
public class AbstractFutureFallbackAtomicHelperTest extends TestCase {
    ...
    /**
     * This classloader blacklists sun.misc.Unsafe which will prevent us from selecting our
     * preferred strategy {@code UnsafeAtomicHelper}.
     */
    private static final ClassLoader NO_UNSAFE = getClassLoader(ImmutableSet.of(sun.misc.Unsafe.class.getName()));

    /**
     * This classloader blacklists sun.misc.Unsafe and AtomicReferenceFieldUpdater which will
     * prevent us from selecting our {@code SafeAtomicHelper} strategy.
     */
    private static final ClassLoader NO_ATOMIC_REFERENCE_FIELD_UPDATER = getClassLoader(
            ImmutableSet.of(sun.misc.Unsafe.class.getName(), AtomicReferenceFieldUpdater.class.getName()));
