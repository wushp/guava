 ...
 *
 * <p>
 * This test class contains various test cases that don't fit into the test case generation in
...
public class SupplementalMonitorTest extends TestCase {
    ...
    private static void verifyOccupiedMethodsInCurrentThread(Monitor monitor, boolean expectedIsOccupied,
            boolean expectedIsOccupiedByCurrentThread, int expectedOccupiedDepth) {
    ...
    private static void verifyOccupiedMethodsInAnotherThread(final Monitor monitor, boolean expectedIsOccupied,
            boolean expectedIsOccupiedByCurrentThread, int expectedOccupiedDepth) {
