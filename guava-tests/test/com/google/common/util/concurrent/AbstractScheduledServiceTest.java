...
public class AbstractScheduledServiceTest extends TestCase {
    ...
    public void testFailOnExceptionFromRun() throws Exception {
        ...
        // An execution exception holds a runtime exception (from throwables.propogate) that holds
        // our
        // original exception.
    ...
    public static class SchedulerTest extends TestCase {
        // These constants are arbitrary and just used to make sure that the correct method is
        // called
        ...
        private void assertSingleCallWithCorrectParameters(Runnable command, long initialDelay, long delay,
                TimeUnit unit) {
        ...
        private static class TestAbstractScheduledCustomService extends AbstractScheduledService {
            ...
            @Override
            protected ScheduledExecutorService executor() {
                // use a bunch of threads so that weird overlapping schedules are more likely to
                // happen.
